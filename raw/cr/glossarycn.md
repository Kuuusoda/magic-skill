...
牌张参考文献，包括所有比赛中合法使用牌的最新叙述（英文）。牌的Oracle叙述可以在Gatherer牌张数据库中找到：[http://Gatherer.Wizards.com]。参见规则[108.1](/cr/1/#cr108-1)。   
...
一个需要被确定数字的占位符。参见规则[107.3](/cr/1/#cr107-3)。   
...
牌的版本符号是印在图片右下角对游戏没有任何效应的小符号。参见规则[206](/cr/2/#cr206)，“版本符号”。   
...
在文字栏下印刷的信息，对游戏本身没有任何影响。参见规则[213](/cr/2/#cr213)，“文字栏下方信息”。   
...
一个关键字异能，具此异能者免受具指定特性之物件的一系列影响。参见规则[702.16](/cr/7/#cr702-16)，“保护”。   
A keyword ability that provides a range of benefits against objects with a specific quality. See rule 702.16, “Protection.”

### <span id='备法牌'>备法牌</span> / <span id='Preparation Card'>Preparation Card</span>
...
### <span id='备法咒语'>备法咒语</span> / <span id='Prepare Spell'>Prepare Spell</span>
...
牌的文字栏中用斜体（但不在括号中）且对游戏没有任何影响的叙述。参见规则[207.2](/cr/2/#cr207-2)。   
...
在一局比赛的两盘之间可以更改套牌的额外的牌。参见规则[100.4](/cr/1/#cr100-4)。   
...
一个关键字异能，允许灵气保护其所结附的永久物。参见规则[702.89](/cr/7/#cr702-89)，“本影甲”。   
...
一个牌手与其他牌手竞技的组织化赛事活动。参见规则[100.6](/cr/1/#cr100-6)。   
...
对认证比赛生效的额外规则。参见规则[100.6](/cr/1/#cr100-6)。   
...
一个关键字异能，让永久物或牌手避免成为对手的目标。参见规则[702.11](/cr/7/#cr702-11)，“辟邪”。   
...
一个关键字异能，允许该牌以牌面朝下的方式，且视为2/2生物一般施放。参见规则[702.37](/cr/7/#cr702-37)，“变身”，和规则[708](/cr/7/#cr708)，“牌面朝下的咒语和永久物”。   
...
### <span id='别名'>别名</span> / <span id='Alternative Cost'>Alternative Cost</span>
...
一个关键字异能，让永久物不会被消灭。参见规则[702.12](/cr/7/#cr702-12)。   
...
一个关键字异能，让牌手在生物上放置+1/+1指示物。参见规则[702.77](/cr/7/#cr702-77)，“补强”。   
...
一个关键字异能，根据你的对手数量减少一个咒语的费用。参见规则[702.125](/cr/7/#cr702-125)，“不屈”。   
...
一个关键字异能，将生物从坟墓场中移回战场上。参见规则[702.93](/cr/7/#cr702-93)，“不息”。   
...
一个关键字异能，让生物在战斗中更好。参见规则[702.25](/cr/7/#cr702-25)，“侧面攻击”。   
...
一个用来决定持续性效应生效顺序的系统。参见规则[613](/cr/6/#cr613)，“持续性效应的互动”。另参见从属关系、时间印记顺序。   
...
一个关键字异能，放逐牌。以此法放逐的牌“缠身”到由缠身异能所指定的目标生物上。参见规则[702.55](/cr/7/#cr702-55)，“缠身”。   
...
一个关键字异能，让一个咒语影响一个目标或多个物件。参见规则[702.96](/cr/7/#cr702-96)，“超载”。   
...
一个关键字异能，使你可以横置生物将另一个生物成为“已乘驾”直到回合结束。参见规则[702.171](/cr/7/#cr702-171)，“乘驾”。   
...
### <span id='持续神器（已废止）'>持续神器（已废止）</span> / <span id='Continuous Effect'>Continuous Effect</span>
...
回合的一部分。该步骤是开始阶段的第一个步骤。参见规则[502](/cr/5/#cr502)，“重置步骤”。   
...
在起动费用中的重置符号{Q}指“重置此永久物”。参见规则[107.6](/cr/1/#cr107-6)。   
...
每当游戏事件或游戏状态符合一个触发式异能的触发事件时，该异能自动“触发”。这表示其操控者在下一词有牌手将得到优先权时将它放进堆叠。参见规则[603](/cr/6/#cr603)，“处理触发式异能”。   
...
### <span id='触发事件'>触发事件</span> / <span id='Triggered Ability'>Triggered Ability</span>
...
### <span id='触发式异能'>触发式异能</span> / <span id='Trigger Event'>Trigger Event</span>
...
触发式异能的第一部分，包含“当”、“每当”、或“在”以及之后的触发事件。参见规则[603](/cr/6/#cr603)，“处理触发式异能”。   
...
一个词，用来确定特殊样式的费用。参见规则[118.12a](/cr/1/#cr118-12a)。   
A word used to indicate a certain style of cost. See rule 118.12a.

### <span id='传纪'>传纪</span> / <span id='Saga'>Saga</span>
一种结界的副类别。传纪具有一系列章节异能，以在数个回合的过程中生效的方式来讲述一段故事。参见规则[714](/cr/7/#cr714)，“传纪牌”。   
...
### <span id='传奇'>传奇</span> / <span id='Legend Rule'>Legend Rule</span>
...
### <span id='传奇规则'>传奇规则</span> / <span id='Legendary'>Legendary</span>
...
传统的万智牌大约2.5英寸（6.3厘米）宽3.5英寸（8.8厘米）长，它们用于牌手的套牌中。参见规则[108.2](/cr/1/#cr108-2)。   
...
一个关键字异能，限制生物可以如何被阻挡和可以如何阻挡。参见规则[702.28](/cr/7/#cr702-28)，“次元幽影”。   
...
一个描述受魂系异能影响之生物的用词。参见规则[702.95](/cr/7/#cr702-95)，“魂系”。   
...
一种多人玩法，很多牌手（通常是十位以上）以个人方式展开对抗。参见规则[807](/cr/8/#cr807)，“大型混战玩法”。   
...
一个关键字异能，让瞬间或法术咒语可以被第二次施放。参见规则[702.88](/cr/7/#cr702-88)，“弹回”。   
...
有且只有一种颜色的物件是单色。无色物件不是单色。参见规则[105](/cr/1/#cr105)，“颜色”，和规则[202](/cr/2/#cr202)，“法术力费用和颜色”。   
...
### <span id='倒转牌'>倒转牌</span> / <span id='Flip Cards'>Flip Cards</span>
在一张牌上具有两部分牌边框（其中之一上下颠倒）的牌。参见规则[710](/cr/7/#cr710)，“倒转牌”。   
...
永久物可具有的一种数字形式的称号。职业结界的等级决定其具有哪些其他异能。参见规则[716](/cr/7/#cr716)，“职业牌”。   
...
该符号表示了一个关键字异能，列出升级牌可能具有的异能、力量以及防御力。参见规则[107.8](/cr/1/#cr107-8)以及规则[711](/cr/7/#cr711)，“升级牌”。   
...
一种牌张类别。地是永久物。参见规则[305](/cr/3/#cr305)，“地”。   
...
### <span id='地行者'>地行者</span> / <span id='Landwalk'>Landwalk</span>
一组关键字异能的集合，限制生物如何可以被阻挡。参见规则[702.14](/cr/7/#cr702-14)，“地行者”。   
A generic term for a group of keyword abilities that restrict whether a creature may be blocked. See rule 702.14, “Landwalk.”

### <span id='递增'>递增</span> / <span id='Increment'>Increment</span>
...
### <span id='定式'>定式</span> / <span id='Paradigm'>Paradigm</span>
...
### <span id='动员'>动员</span> / <span id='Mobilize'>Mobilize</span>
一个关键字异能，派出若干已横置且正进行攻击的红色战士衍生生物，且在下一个结束步骤开始时牺牲之。参见规则[702.181](/cr/7/#cr702-181)，“动员”。   
...
牌手正在对局的人。参见规则[102.2](/cr/1/#cr102-2)和[102.3](/cr/1/#cr102-3)。   
...
限制哪些生物可以阻挡攻击生物的异能。参见规则[509.1b](/cr/5/#cr509-1b)至c。   
...
具有两个或更多颜色的物件便是多色。多色并不是一种颜色。参见规则[105](/cr/1/#cr105)，“颜色”，和规则[202](/cr/2/#cr202)，“法术力费用和颜色”。   
...
多重增幅是增幅关键字异能的变化形式。它代表一种可以支付任意次的可选额外费用。参见规则[702.33](/cr/7/#cr702-33)，“增幅”。另参见增幅。   
...
### <span id='额外回合'>额外回合</span> / <span id='Extra Turn'>Extra Turn</span>
由咒语或异能的效应所创造的回合。参见规则[500.7](/cr/5/#cr500-7)。对于使用队伍共享回合模式的多人游戏的额外回合规则，参见规则[805.8](/cr/8/#cr805-8)。对于大型混战玩法游戏的额外回合规则，参见规则[807.4](/cr/8/#cr807-4)。   
...
一个关键字异能，在牌手没有速度时使其速度成为1。一旦牌手具有速度，于其自己的每个回合中且限一次，当有对手失去生命时，其速度便会增加1。参见规则[702.179](/cr/7/#cr702-179)，“发动引擎！”。   
...
一种牌张类别。法术不是永久物。参见规则[307](/cr/3/#cr307)，“法术”。   
A card type. A sorcery is not a permanent. See rule 307, “Sorceries.”

### <span id='法术力'>法术力</span> / <span id='Mana'>Mana</span>
游戏中的主要资源。法术力用来支付费用，这通常发生在施放咒语或起动异能时。参见规则[106](/cr/1/#cr106)，“法术力”，规则[107.4](/cr/1/#cr107-4)，和规则[202](/cr/2/#cr202)，“法术力费用和颜色”。   
...
由效应产生的法术力临时存储的地方。参见规则[106.4](/cr/1/#cr106-4)。   
...
产生该法术力的咒语，或产生该法术力的异能之来源。参见规则[106.3](/cr/1/#cr106-3)。   
...
牌的一部分，且是一种特征。一张牌的法术力费用由印在该牌右上角的法术力符号所指示。参见规则[107.4](/cr/1/#cr107-4)和规则[202](/cr/2/#cr202)，“法术力费用和颜色”。   
...
表示法术力或法术力费用的符号。参见规则[107.4](/cr/1/#cr107-4)。   
...
一类起动式或触发式异能，它们可以产生法术力，且不使用堆叠。参见规则[605](/cr/6/#cr605)，“法术力异能”。   
...
一个法术力费用中法术力的总数，不计较颜色。参见规则[202.3](/cr/2/#cr202-3)。   
...
### <span id='繁生'>繁生</span> / <span id='Offspring'>Offspring</span>
一个关键字异能，允许你施放生物咒语时支付额外费用，在该永久物进战场时派出为其复制品的1/1衍生物。参见规则[702.175](/cr/7/#cr702-175)，“繁生”。   
...
一个触发式异能，能使生物向所有可能的方向攻击。参见规则[702.116](/cr/7/#cr702-116)，“繁影”。   
...
一个关键字异能，让牌手从其坟墓场中施放一张牌。参见规则[702.34](/cr/7/#cr702-34)，“返照”。   
...
1. 地城牌的一个分区。参见规则[309](/cr/3/#cr309)，“地城”。   
1. A subsection of a dungeon card. See rule 309, “Dungeons.”

2. 一种结界的副类别，见于一些连体牌上。参见规则[709](/cr/7/#cr709)，“连体牌”。   
...
一个触发式异能，每当牌手将其进度标记移动到地城牌的一个房间中时触发。参见规则[309](/cr/3/#cr309)，“地城”。   
...
1. 只有生物牌具有的牌的一部分。生物牌的防御力印在其右下角斜线之后。参见规则[208](/cr/2/#cr208)，“力量/防御力”。   
...
一类持续性效应，等待将要发生的伤害事件，并完全或部分地防止将要造成的伤害。参见规则[615](/cr/6/#cr615)，“防止性效应”。   
...
（已废止）一些咒语和异能先前提及指示物“被放置(placed)”在永久物上。这些牌张在Oracle牌张参考文献中得到勘误，现使用“放置(put)”一词。由于规则变动，这些牌张仍能如往常一般地正常运作。参见规则[122](/cr/1/#cr122)，“指示物”。   
...
不包含在牌手套牌中的一种牌。它们可能是大号尺寸，或具有不为“Deckmaster”的背面。参见规则[108.2](/cr/1/#cr108-2)。   
...
一个目标不再存在或不在符合目标它的该咒语或异能所列出的特别要求。参见规则[608.2b](/cr/6/#cr608-2b)。   
...
任何不具有超类别“基本”的地。参见规则[205.4](/cr/2/#cr205-4)，“超类别”。   
...
规则叙述中使用的一种符号，代表五种非瑞克西亚法术力符号中的任何一种。参见规则[107.4g](/cr/1/#cr107-4g)。   
...
一个关键字异能，限制一个生物如何被阻挡。参见规则[702.9](/cr/7/#cr702-9)，“飞行”。   
...
一个关键字异能，创造咒语的复制品。参见规则[702.69](/cr/7/#cr702-69)，“坟场风暴”。   
A keyword ability that creates copies of a spell. See rule 702.69, “Gravestorm.”

### <span id='分级'>分级</span> / <span id='Tiered'>Tiered</span>
...
一个斜体印刷的词，使得异能的叙述更显鲜活，但没有规则含义。参见规则[207.2d](/cr/2/#cr207-2d)。   
...
出现在左上角印有别名的牌上的一个较小的名称栏，包含其Oracle牌张参考文献中的名称。参见规则[201.6](/cr/2/#cr201-6)。   
...
一个特征，在类别栏中牌张类别和长横线（中文版使用“～”）后面。参见规则[205.3](/cr/2/#cr205-3)，“副类别”。   
...
一个关键字异能，创造咒语的复制品。参见规则[702.56](/cr/7/#cr702-56)，“覆诵”。   
...
一种游戏辅助用品，具有万智牌牌背，可用于代表一张双面牌或融合牌。参见规则[713](/cr/7/#cr713)，“辅助牌”。   
...
一个改变物件的牌张类别、副类别、和/或超类别的效应。参见规则[205.1a-b](/cr/2/#cr205-1a)、[305.7](/cr/3/#cr305-7)、以及[613.1d](/cr/6/#cr613-1d)。   
...
与物件改变区域相关的触发事件。参见规则[603.6](/cr/6/#cr603-6)。   
...
改变物件文字栏内和/或类别栏内文字叙述的持续性效应。参见规则[612](/cr/6/#cr612)，“改变叙述的效应”。   
...
使用“改为”一词的效应为替代性效应。“改为”一词指明将要被替代的事件。参见规则[614](/cr/6/#cr614)，“替代性效应”。   
...
一个关键字异能，影响物件如何对生物造成伤害。参见规则[702.80](/cr/7/#cr702-80)，“干枯”。   
...
### <span id='隔位分队玩法'>隔位分队玩法</span> / <span id='Alternate Name'>Alternate Name</span>
...
所有牌手都可以看到其中牌面的区域。参见规则[400.2](/cr/4/#cr400-2)。另参见隐藏区域。   
...
一个神器副类别。工事可以贴附于地上。参见规则[301](/cr/3/#cr301)，“神器”，以及规则[702.67](/cr/7/#cr702-67)，“构工”。   
...
在双头巨人多人玩法中，每个队伍具有“共享总生命”而不是每位牌手有单独的总生命。参见规则[810](/cr/8/#cr810)，“双头巨人玩法”。   
...
一个关键字异能，让牌手将工事牌贴附于其操控的地上。参见规则[301](/cr/3/#cr301)，“神器”，以及规则[702.67](/cr/7/#cr702-67)，“构工”。   
...
一个动词，例如“消灭”或“施放”，用来作为游戏用语而不是其正常的词意。参见规则[701](/cr/7/#cr701)，“关键字动作”。   
...
一个游戏用语，例如“飞行”或“敏捷”，用来简述一个很长的异能或一组异能。参见规则[702](/cr/7/#cr702)，“关键字异能”。   
...
一个放置在物件上的标示物，赋予其一个关键字异能以影响其特征。参见规则[122](/cr/1/#cr122)，“指示物”。   
...
在同一个物件上印的两个异能，其中一个将直接影响另一个提到的将进行的动作或受影响的物件。参见规则[607](/cr/6/#cr607)，“关联异能”。   
...
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{U}。”参见规则[305.6](/cr/3/#cr305-6)。   
...
### <span id='横置符号'>横置符号</span> / <span id='Tapped'>Tapped</span>
...
一种指示物，保护永久物不受伤害、不被消灭。参见规则[122.1c](/cr/1/#cr122-1c)。   
...
一个关键字异能，当永久物进入战场时令其被牺牲。参见规则[702.74](/cr/7/#cr702-74)，“呼魂”。   
...
一个出现在某些异能中的用词，在乎牌手本回合中用于施放咒语的法术力数量。参见规则[700.14](/cr/7/#cr700-14)。   
...
### <span id='回合标记'>回合标记</span> / <span id='Turn-Based Actions'>Turn-Based Actions</span>
...
### <span id='回合动作'>回合动作</span> / <span id='Turn Markers'>Turn Markers</span>
...
一个关键字异能，让永久物进入战场时具有+1/+1指示物或充电指示物。参见规则[702.44](/cr/7/#cr702-44)，“辉映”。   
...
一个关键字异能，让生物组成搭档时更强。参见规则[702.95](/cr/7/#cr702-95)，“魂系”。   
...
一个法术力符号，表示费用可以用两种中的一种支付。参见规则[107.4](/cr/1/#cr107-4)。   
...
一个法术力符号，表示费用可以用三种中的一种支付。参见规则[107.4](/cr/1/#cr107-4)。   
...
在法术力费用中具有一个或数个混血法术力符号的牌。参见规则[202.2f](/cr/2/#cr202-2f)。   
...
一个关键字异能，派出一个0/0黑色非瑞人／病菌衍生生物，并将具有该异能的武具贴附于该衍生物上。参见规则[702.92](/cr/7/#cr702-92)，“活化武器”。   
...
### <span id='基本地类别'>基本地类别</span> / <span id='Basic Landcycling'>Basic Landcycling</span>
...
### <span id='加两倍'>加两倍</span> / <span id='Triple'>Triple</span>
...
一个关键字异能，影响生物如何分配战斗伤害。参见规则[702.19](/cr/7/#cr702-19)，“践踏”。   
...
一个关键字异能，意指“每当此生物与至少一个力量较之为大的其他生物一起攻击时，在此生物上放置一个+1/+1指示物。”参见规则[702.149](/cr/7/#cr702-149)，“见习”。   
...
皇帝多人玩法中，任何不是皇帝的牌手。参见规则[809](/cr/8/#cr809)，“皇帝玩法”。   
...
### <span id='结束回合'>结束回合</span> / <span id='End the Turn'>End the Turn</span>
...
### <span id='解锁'>解锁</span> / <span id='Unlock'>Unlock</span>
令一边或数边已上锁的永久物得到一个解锁称号。参见规则[709.5g](/cr/7/#cr709-5g)。   
To give an unlocked designation to a permanent that has one or more locked halves. See rule 709.5f.

### <span id='接殖'>接殖</span> / <span id='Graft'>Graft</span>
一个关键字异能，让一个永久物进入战场带有+1/+1指示物，以及这些指示物可以移动到其他生物上。参见规则[702.58](/cr/7/#cr702-58)，“接殖”。   
...
### <span id='进场'>进场</span> / <span id='Enter'>Enter</span>
...
### <span id='进度标记'>进度标记</span> / <span id='Venture Marker'>Venture Marker</span>
一种标记，用来记录牌手当前在地城牌的哪个房间中。参见规则[309](/cr/3/#cr309)，“地城”。   
A marker used to track which room of a dungeon card a player is currently in. See rule 309, “Dungeons.”

### <span id='进化'>进化</span> / <span id='Evolve'>Evolve</span>
一个关键字异能，每当一个更大的生物在你的操控下进入战场时，让你将+1/+1指示物放在生物上。参见规则[702.100](/cr/7/#cr702-100)，“进化”。   
...
### <span id='进入战场'>进入战场</span> / <span id='Enters the Battlefield'>Enters the Battlefield</span>
...
### <span id='金属生命体'>金属生命体</span> / <span id='Living Metal'>Living Metal</span>
一个见于载具上的关键字异能，能够令其在你的回合中变为生物。参见规则[702.161](/cr/7/#cr702-161)，“金属生命体”。   
A keyword ability found on some Vehicles that turns them into a creature during your turn. See rule 702.161, “Living Metal.”

### <span id='进行攻击的生物'>进行攻击的生物</span> / <span id='Attacking Creature'>Attacking Creature</span>
...
### <span id='进行阻挡的生物'>进行阻挡的生物</span> / <span id='Blocking Creature'>Blocking Creature</span>
...
### <span id='景点'>景点</span> / <span id='Attraction'>Attraction</span>
...
### <span id='景点套牌'>景点套牌</span> / <span id='Attraction Deck'>Attraction Deck</span>
...
### <span id='警戒'>警戒</span> / <span id='Vigilance'>Vigilance</span>
一个关键字异能，让生物进行攻击不需横置。参见规则[702.20](/cr/7/#cr702-20)，“警戒”。   
A keyword ability that lets a creature attack without tapping. See rule 702.20, “Vigilance.”

### <span id='惊扰'>惊扰</span> / <span id='Disturb'>Disturb</span>
...
### <span id='静止式异能'>静止式异能</span> / <span id='Static Ability'>Static Ability</span>
一种异能。静止式异能时刻都生效而不是被起动或触发。参见规则[113](/cr/1/#cr113)，“异能”，以及规则[604](/cr/6/#cr604)，“处理静止式异能”。   
...
### <span id='竞逐时空'>竞逐时空</span> / <span id='Planechase'>Planechase</span>
一种休闲式玩法，时空牌和异象牌为游戏带来额外的异能和随机性。参见规则[901](/cr/9/#cr901)，“竞逐时空”。   
...
### <span id='局'>局</span> / <span id='Match'>Match</span>
在比赛中进行的一盘多人游戏或一系列双人游戏（通常是三局两胜制）。参见规则[100.6](/cr/1/#cr100-6)。   
A multiplayer game or a two-player series of games (usually best-two-of-three) played in a tournament. See rule 100.6.

### <span id='剧毒'>剧毒</span> / <span id='Poisonous'>Poisonous</span>
一个关键字异能，使牌手获得中毒指示物。参见规则[702.70](/cr/7/#cr702-70)，“剧毒”。   
A keyword ability that causes a player to get poison counters. See rule 702.70, “Poisonous.”

### <span id='拘留'>拘留</span> / <span id='Detain'>Detain</span>
...
### <span id='具有模式的，模式'>具有模式的，模式</span> / <span id='Modal, Mode'>Modal, Mode</span>
如果某咒语或异能以项目列表的格式提供了两种或以上的选择，且以指示牌手从这些选项中选择数项的字样开头，例如“选择一项～”，此咒语或异能便具有模式。参见规则[700.2](/cr/7/#cr700-2)。   
...
### <span id='角色'>角色</span> / <span id='Role'>Role</span>
角色是无色结界衍生物。每一种角色都具有灵气／角色的副类别，以及“结附于生物”的异能。如果某个永久物其上结附有由同一位牌手操控的数个角色，则除了具最近之时间印记者外，所有其他这类角色都会被置入其拥有者的坟墓场。参见规则[303.7](/cr/3/#cr303-7)及规则[111.10j-r](/cr/1/#cr111-10j)。   
...
### <span id='掘穴'>掘穴</span> / <span id='Delve'>Delve</span>
...
### <span id='君主'>君主</span> / <span id='Monarch'>Monarch</span>
...
## K
### <span id='开始阶段'>开始阶段</span> / <span id='Beginning Phase'>Beginning Phase</span>
...
### <span id='勘察'>勘察</span> / <span id='Explore'>Explore</span>
...
### <span id='可复制特征值'>可复制特征值</span> / <span id='Copiable Values'>Copiable Values</span>
...
### <span id='恐惧'>恐惧</span> / <span id='Fear'>Fear</span>
一个关键字异能，限制一个生物能如何被阻挡。参见规则[702.36](/cr/7/#cr702-36)，“恐惧”。   
A keyword ability that restricts how a creature may be blocked. See rule 702.36, “Fear.”

### <span id='狂暴'>狂暴</span> / <span id='Rampage'>Rampage</span>
一个关键字异能，让生物在战斗中更强。参见规则[702.23](/cr/7/#cr702-23)，“狂暴”。   
A keyword ability that can make a creature better in combat. See rule 702.23, “Rampage.”

### <span id='狂热'>狂热</span> / <span id='Free-for-All'>Free-for-All</span>
...
## L
### <span id='拉德指示物'>拉德指示物</span> / <span id='Rad Counter'>Rad Counter</span>
...
### <span id='类别'>类别</span> / <span id='Type'>Type</span>
...
### <span id='类别符号'>类别符号</span> / <span id='Type Icon'>Type Icon</span>
在一些预知将来版本的卡牌左上角有类别符号，它们对游戏没有影响。参见规则[107.10](/cr/1/#cr107-10)。   
An icon that appears in the upper left of some Future Sight cards that has no effect on game play. See rule 107.10.

### <span id='类别栏'>类别栏</span> / <span id='Type Line'>Type Line</span>
牌的一部分。类别栏印在图片的下方，包括该牌的牌张类别、副类别、和/或超类别。参见规则[205](/cr/2/#cr205)，“类别栏”。   
...
### <span id='类别循环'>类别循环</span> / <span id='Typecycling'>Typecycling</span>
一种循环异能。参见规则[702.29](/cr/7/#cr702-29)，“循环”。   
A variant of the cycling ability. See rule 702.29, “Cycling.”

### <span id='累积维持'>累积维持</span> / <span id='Cumulative Upkeep'>Cumulative Upkeep</span>
...
### <span id='历传'>历传</span> / <span id='Epic'>Epic</span>
...
1. 只有生物牌具有的牌的一部分。生物牌的力量印在其右下角斜线之前。参见规则[208](/cr/2/#cr208)，“力量/防御力”。   
...
### <span id='连体牌'>连体牌</span> / <span id='Split Cards'>Split Cards</span>
在一张牌上有两张牌面。参见规则[709](/cr/7/#cr709)，“连体牌”。   
Cards with two card faces on a single card. See rule 709, “Split Cards.”

### <span id='灵技'>灵技</span> / <span id='Prowess'>Prowess</span>
一个关键字异能，当生物的操控者施放非生物咒语时，使该生物得+1/+1。参见规则[702.108](/cr/7/#cr702-108)，“灵技”。   
...
### <span id='灵气'>灵气</span> / <span id='Aura'>Aura</span>
...
### <span id='灵气转换'>灵气转换</span> / <span id='Aura Swap'>Aura Swap</span>
...
### <span id='留存'>留存</span> / <span id='Persist'>Persist</span>
一个关键字异能，可以将生物从坟场返回战场。参见规则[702.79](/cr/7/#cr702-79)，“留存”。   
A keyword ability that can return a creature from the graveyard to the battlefield. See rule 702.79, “Persist.”

### <span id='乱斗'>乱斗</span> / <span id='Melee'>Melee</span>
一个关键字异能，根据你攻击的对手数量来强化一个进攻生物。参见规则[702.121](/cr/7/#cr702-121)，“乱斗”。   
...
### <span id='轮抽/抽选（译者注：在英文中这两个词是相同的。）'>轮抽/抽选（译者注：在英文中这两个词是相同的。）</span> / <span id='Draft'>Draft</span>
...
### <span id='轮抽轮次'>轮抽轮次</span> / <span id='Draft Round'>Draft Round</span>
...
### <span id='伦敦再调度'>伦敦再调度</span> / <span id='London Mulligan'>London Mulligan</span>
指代当前的再调度规则的非正式用词。参见规则[103.5](/cr/1/#cr103-5)。   
Informal term for the current system of mulligan rules. See rule 103.5.

### <span id='论命'>论命</span> / <span id='Fateseal'>Fateseal</span>
...
### <span id='略过'>略过</span> / <span id='Skip'>Skip</span>
使用“略过”一词的效应为替代性效应。“略过”一词表示哪个事件、步骤、阶段或回合将被什么都不发生替代。参见规则[614](/cr/6/#cr614)，“替代性效应”。   
...
## M
### <span id='马术'>马术</span> / <span id='Horsemanship'>Horsemanship</span>
...
### <span id='埋葬（已废止）'>埋葬（已废止）</span> / <span id='Bury (Obsolete)'>Bury (Obsolete)</span>
...
### <span id='蛮化（动作）'>蛮化（动作）</span> / <span id='Monstrosity'>Monstrosity</span>
...
### <span id='蛮化（状况）/已蛮化'>蛮化（状况）/已蛮化</span> / <span id='Monstrous'>Monstrous</span>
...
### <span id='锚定词'>锚定词</span> / <span id='Anchor Word'>Anchor Word</span>
...
### <span id='冒险团'>冒险团</span> / <span id='Party'>Party</span>
一些牌提及你冒险团中的生物数量。牌手的冒险团由僧侣、浪客、战士和法术师组成，每种类别至多只计入一个。参见规则[700.8](/cr/7/#cr700-8)。   
...
### <span id='冒险团满编'>冒险团满编</span> / <span id='Full Party'>Full Party</span>
当牌手冒险团中的生物数量为四时，其冒险团满编。参见规则[700.8](/cr/7/#cr700-8)。   
A player has a full party if the number of creatures in their party is four. See rule 700.8.

### <span id='门槛'>门槛</span> / <span id='Threshold'>Threshold</span>
“门槛”曾经是关键字异能。现在是异能提示且没有规则意义。所有印有门槛的牌都在Oracle牌张参考文献中得到了勘误。   
...
### <span id='门票符号'>门票符号</span> / <span id='Ticket Symbol'>Ticket Symbol</span>
内部没有数字的门票符号{TK}代表一个门票指示物。内部有数字的门票符号代表门票费用。要支付门票费用，牌手从其自身移除相应数量的门票指示物。   
...
### <span id='秘案'>秘案</span> / <span id='Hidden Agenda'>Hidden Agenda</span>
一个关键字异能，让诡局牌以牌面朝下的方式置于统帅区。参见规则[702.106](/cr/7/#cr702-106)，“秘案”。   
A keyword ability that allows a conspiracy card to be put into the command zone face down. See rule 702.106, “Hidden Agenda.”

### <span id='觅粮'>觅粮</span> / <span id='Forage'>Forage</span>
...
### <span id='秘罗万岁！'>秘罗万岁！</span> / <span id='For Mirrodin!'>For Mirrodin!</span>
一个关键字异能，派出一个2/2红色反抗军衍生生物，并将具有该异能的武具贴附于该衍生物上。参见规则[702.163](/cr/7/#cr702-163)，“秘罗万岁！”。   
...
### <span id='面临邪恶抉择'>面临邪恶抉择</span> / <span id='Face a Villainous Choice'>Face a Villainous Choice</span>
...
### <span id='敏捷'>敏捷</span> / <span id='Haste'>Haste</span>
一个关键字异能，让生物可以忽略“召唤失调”规则。参见规则[702.10](/cr/7/#cr702-10)，“敏捷”，以及规则[302.6](/cr/3/#cr302-6)。   
A keyword ability that lets a creature ignore the “summoning sickness” rule. See rule 702.10, “Haste,” and rule 302.6.

### <span id='名称'>名称</span> / <span id='Name'>Name</span>
一个特征，也是牌的一部分。牌的名称印在它的左上角。参见规则[201](/cr/2/#cr201)，“名称”。   
A characteristic, and part of a card. A card’s name is printed in its upper left corner. See rule 201, “Name.”

### <span id='铭勇'>铭勇</span> / <span id='Renown'>Renown</span>
一个关键字异能，使生物对牌手造成过战斗伤害之后变得更强。参见规则[702.112](/cr/7/#cr702-112)，“铭勇”。   
A keyword ability that makes a creature stronger after it deals combat damage to a player. See rule 702.112, “Renown.”

### <span id='磨'>磨</span> / <span id='Mill'>Mill</span>
...
### <span id='魔戒'>魔戒</span> / <span id='The Ring'>The Ring</span>
...
### <span id='魔戒引诱你'>魔戒引诱你</span> / <span id='The Ring Tempts You'>The Ring Tempts You</span>
...
### <span id='魔力石衍生物'>魔力石衍生物</span> / <span id='Powerstone Token'>Powerstone Token</span>
...
### <span id='魔王'>魔王</span> / <span id='Archenemy'>Archenemy</span>
...
### <span id='魔王指挥官'>魔王指挥官</span> / <span id='Archenemy Commander'>Archenemy Commander</span>
...
### <span id='墓碑标志'>墓碑标志</span> / <span id='Tombstone Icon'>Tombstone Icon</span>
在一些奥德赛环境牌的左上角有墓碑符号，它对游戏没有影响。参见规则[107.9](/cr/1/#cr107-9)。   
...
### <span id='匿伏'>匿伏</span> / <span id='Cloak'>Cloak</span>
...
### <span id='你，你的'>你，你的</span> / <span id='You, Your'>You, Your</span>
指一个物件的操控者、它即将的操控者（如果牌手正准备施放或起动它），或它的拥有者（如果没有操控者）。参见规则[109.5](/cr/1/#cr109-5)。   
...
## P
### <span id='牌'>牌</span> / <span id='Card'>Card</span>
...
### <span id='牌池'>牌池</span> / <span id='Card Pool'>Card Pool</span>
...
### <span id='派出'>派出</span> / <span id='Create'>Create</span>
...
参见规则[401](/cr/4/#cr401)，“牌库”。   
See rule 401, “Library.”

### <span id='牌面朝上'>牌面朝上</span> / <span id='Face Up'>Face Up</span>
...
### <span id='牌面朝下'>牌面朝下</span> / <span id='Face Down'>Face Down</span>
...
3. 牌面朝下的咒语具有额外规则。参见规则[708](/cr/7/#cr708)，“牌面朝下的咒语和永久物”，以及规则[702.37](/cr/7/#cr702-37)，“变身”。   
3. Face-down spells have additional rules. See rule 708, “Face-Down Spells and Permanents,” and rule 702.37, “Morph.”

### <span id='牌手'>牌手</span> / <span id='Player'>Player</span>
游戏中的人之一。参见规则[102](/cr/1/#cr102)，“牌手”。   
One of the people in the game. See rule 102, “Players.”

### <span id='牌张类别'>牌张类别</span> / <span id='Card Type'>Card Type</span>
...
### <span id='佩带'>佩带</span> / <span id='Equip'>Equip</span>
...
### <span id='鹏洛客符号'>鹏洛客符号</span> / <span id='Planeswalker Symbol'>Planeswalker Symbol</span>
鹏洛客符号出现在竞逐时空休闲式玩法中使用的时空骰上。参见规则[107.11](/cr/1/#cr107-11)。   
The Planeswalker symbol appears on the planar die in the Planechase casual variant. See rule 107.11.

### <span id='鹏洛客类别'>鹏洛客类别</span> / <span id='Planeswalker Type'>Planeswalker Type</span>
与鹏洛客牌张类别相关的副类别。参见规则[306](/cr/3/#cr306)，“鹏洛客”。参见规则[205.3j](/cr/2/#cr205-3j)查看鹏洛客类别的列表。   
...
### <span id='鹏洛客唯一规则（已废止）'>鹏洛客唯一规则（已废止）</span> / <span id='Planeswalker Uniqueness Rule (Obsolete)'>Planeswalker Uniqueness Rule (Obsolete)</span>
先前版本的规则叙述牌手操控两个或更多具有相同鹏洛客类别的鹏洛客时，除留下其中之一外，其余均置于其拥有者的坟墓场。此规则曾称为“鹏洛客唯一规则”，现已不复存在。   
...
### <span id='鹏洛客（旧译旅法师）'>鹏洛客（旧译旅法师）</span> / <span id='Planeswalker'>Planeswalker</span>
一种牌张类别。鹏洛客是永久物。参见规则[306](/cr/3/#cr306)，“鹏洛客”。   
A card type. A planeswalker is a permanent. See rule 306, “Planeswalkers.”

### <span id='偏门'>偏门</span> / <span id='Door'>Door</span>
一扇偏门是隔间永久物的一边。参见规则[709](/cr/7/#cr709)，“连体牌”。   
A door is one half of a Room permanent. See rule 709, “Split Cards.”

### <span id='拼造'>拼造</span> / <span id='Improvise'>Improvise</span>
一个关键字异能，使你可以在施放咒语时横置神器代替法术力来支付费用。   
A keyword ability that lets you tap artifacts rather than pay mana to cast a spell. See rule 702.126, “Improvise.”

### <span id='平原'>平原</span> / <span id='Plains'>Plains</span>
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{W}。”参见规则[305.6](/cr/3/#cr305-6)。   
One of the five basic land types. Any land with this subtype has the ability “{T}: Add {W}.” See rule 305.6.

### <span id='平原行者'>平原行者</span> / <span id='Plainscycling'>Plainscycling</span>
参见类别循环。   
See Typecycling.

### <span id='平原行者'>平原行者</span> / <span id='Plainswalk'>Plainswalk</span>
参见地行者。   
See Landwalk.

### <span id='破坟'>破坟</span> / <span id='Unearth'>Unearth</span>
一个关键字异能，让牌手将生物牌从坟墓场中移回战场上。参见规则[702.84](/cr/7/#cr702-84)，“破坟”。   
...
### <span id='普世'>普世</span> / <span id='World'>World</span>
一种超类别，一般情况下与结界有关。参见规则[205.4](/cr/2/#cr205-4)，“超类别”。另参见普世规则。   
A supertype that’s normally relevant on enchantments. See rule 205.4, “Supertypes.” See also World Rule.

### <span id='普世规则'>普世规则</span> / <span id='World Rule'>World Rule</span>
一个状态动作，让所有具有普世超类别的永久物，除了拥有普世超类别时间最短的一个以外，皆置入其拥有者的坟墓场。参见规则[704.5k](/cr/7/#cr704-5k)。   
...
## Q
### <span id='起动'>起动</span> / <span id='Activate'>Activate</span>
...
### <span id='起动费用'>起动费用</span> / <span id='Activation Cost'>Activation Cost</span>
...
### <span id='起动式异能'>起动式异能</span> / <span id='Activated Ability'>Activated Ability</span>
...
### <span id='奇迹'>奇迹</span> / <span id='Miracle'>Miracle</span>
一个关键字异能，如果该牌是回合中你所抓的第一张牌，便允许你用较低的费用施放它。参见规则[702.94](/cr/7/#cr702-94)，“奇迹”。   
...
### <span id='弃牌'>弃牌</span> / <span id='Discard'>Discard</span>
...
### <span id='起事'>起事</span> / <span id='Riot'>Riot</span>
一个关键字异能，使牌手在某些生物进战场时选择其具有敏捷或是带有一个+1/+1指示物。参见规则[702.136](/cr/7/#cr702-136)，“起事”。   
...
### <span id='起始套牌'>起始套牌</span> / <span id='Starting Deck'>Starting Deck</span>
在牌手将其备牌放在一边之后，其余的套牌便成为其起始套牌。参见规则[103.2a](/cr/1/#cr103-2a)。   
After a player has set aside their sideboard, their remaining deck becomes their starting deck. See rule 103.2a.

### <span id='起始总生命'>起始总生命</span> / <span id='Starting Life Total'>Starting Life Total</span>
牌手在游戏开始时的生命总值。在大多数游戏中，每位牌手的起始总生命为20。参见规则[103.4](/cr/1/#cr103-4)。   
The amount of life a player has as a game begins. In most games, each player’s starting life total is 20. See rule 103.4.

### <span id='起手'>起手</span> / <span id='Opening Hand'>Opening Hand</span>
在牌手决定不再调度之后，其开始游戏时手上的牌。参见规则[103.5](/cr/1/#cr103-5)。   
...
### <span id='起手牌数量'>起手牌数量</span> / <span id='Starting Hand Size'>Starting Hand Size</span>
...
### <span id='潜匿'>潜匿</span> / <span id='Skulk'>Skulk</span>
一个关键字异能，限制一个生物能够如何被阻挡。参见规则[702.118](/cr/7/#cr702-118)，“潜匿”。   
A keyword ability that restricts how a creature may be blocked. See rule 702.118, “Skulk.”

### <span id='墙'>墙</span> / <span id='Wall'>Wall</span>
...
### <span id='敲诈'>敲诈</span> / <span id='Extort'>Extort</span>
一个关键字异能，每当你施放咒语时让你得到生命并且让对手失去生命。参见规则[702.101](/cr/7/#cr702-101)，“敲诈”。   
A keyword ability that lets you gain life and have opponents lose life whenever you cast a spell. See rule 702.101, “Extort.”

### <span id='侵染'>侵染</span> / <span id='Infect'>Infect</span>
一个关键字异能，影响一个物件如何对生物或牌手造成伤害。参见规则[702.90](/cr/7/#cr702-90)，“侵染”。   
A keyword ability that affects how an object deals damage to creatures and players. See rule 702.90, “Infect.”

### <span id='亲缘'>亲缘</span> / <span id='Kindred'>Kindred</span>
一种牌张类别。亲缘是否为永久物取决于它的其他牌张类别。参见规则[308](/cr/3/#cr308)，“亲缘”。   
A card type. Whether or not a kindred is a permanent depends on its other card type. See rule 308, “Kindreds.”

### <span id='清除步骤'>清除步骤</span> / <span id='Cleanup Step'>Cleanup Step</span>
...
### <span id='倾探'>倾探</span> / <span id='Discover'>Discover</span>
...
### <span id='倾曳'>倾曳</span> / <span id='Cascade'>Cascade</span>
...
### <span id='请援'>请援</span> / <span id='Behold'>Behold</span>
...
### <span id='区域'>区域</span> / <span id='Zone'>Zone</span>
在游戏过程中物件所处于的位置。参见[第4章](/cr/4/)，“区域”。   
A place where objects can be during a game. See section 4, “Zones.”

### <span id='群魔乱斗'>群魔乱斗</span> / <span id='Supervillain Rumble'>Supervillain Rumble</span>
每位牌手都是魔王的自由竞赛游戏。参见规则[806](/cr/8/#cr806)，“自由竞赛模式”和规则[904](/cr/9/#cr904)，“魔王”。   
A Free-for-All game in which each player is an archenemy. See rule 806, “Free-for-All,” and rule 904, “Archenemy.”

## R
### <span id='让过'>让过</span> / <span id='Pass'>Pass</span>
在拥有优先权时不执行动作（例如施放咒语或起动异能）。参见规则[117](/cr/1/#cr117)，“时机和优先权”。   
...
### <span id='认输'>认输</span> / <span id='Concede'>Concede</span>
...
### <span id='忍术'>忍术</span> / <span id='Ninjutsu'>Ninjutsu</span>
一个关键字异能，让生物突然加入战斗。参见规则[702.49](/cr/7/#cr702-49)，“忍术”。   
A keyword ability that lets a creature suddenly enter combat. See rule 702.49, “Ninjutsu.”

### <span id='任意一个目标'>任意一个目标</span> / <span id='Any Target'>Any Target</span>
...
### <span id='融合'>融合</span> / <span id='Meld'>Meld</span>
...
### <span id='融合牌'>融合牌</span> / <span id='Meld Cards'>Meld Cards</span>
一种牌，一面具有万智牌的牌面，另一面是一张大号万智牌卡牌的一半。参见规则[712](/cr/7/#cr712)，“双面牌”。   
...
### <span id='融咒'>融咒</span> / <span id='Fuse'>Fuse</span>
一个关键字异能，让牌手可以施放连体牌的两边。参见规则[702.102](/cr/7/#cr702-102)，“融咒”。   
A keyword ability that allows a player to cast both halves of a split card. See rule 702.102, “Fuse.”

### <span id='融咒连体咒语'>融咒连体咒语</span> / <span id='Fused Split Spell'>Fused Split Spell</span>
一张堆叠中的连体牌，使用融咒异能施放，或该种牌的复制品。参见规则[702.102](/cr/7/#cr702-102)，“融咒”。   
A split card on the stack that has been cast using the fuse ability or a copy of such a card. See rule 702.102, “Fuse.”

### <span id='如果'>如果</span> / <span id='If'>If</span>
参见以“若”开头的子句。   
...
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{R}。”参见规则[305.6](/cr/3/#cr305-6)。   
One of the five basic land types. Any land with this subtype has the ability “{T}: Add {R}.” See rule 305.6.

### <span id='山脉行者'>山脉行者</span> / <span id='Mountainwalk'>Mountainwalk</span>
参见地行者。   
See Landwalk.

### <span id='闪现'>闪现</span> / <span id='Flash'>Flash</span>
一个关键字异能，让牌手在任何其可以施放瞬间的时候使用一张牌。参见规则[702.8](/cr/7/#cr702-8)，“闪现”。   
A keyword ability that lets a player play a card any time they could cast an instant. See rule 702.8, “Flash.”

### <span id='伤害'>伤害</span> / <span id='Damage'>Damage</span>
...
### <span id='伤害的来源'>伤害的来源</span> / <span id='Source of Damage'>Source of Damage</span>
造成伤害的物件。参见规则[609.7](/cr/6/#cr609-7)。   
...
令一边或数边已解锁的永久物失去一个解锁称号。参见规则[709.5g](/cr/7/#cr709-5g)。   
To remove an unlocked designation from a permanent that has one or more unlocked halves. See rule 709.5g.

### <span id='设谋'>设谋</span> / <span id='Plot'>Plot</span>
一个关键字异能，允许牌手从手上放逐牌并在之后的回合中施放，且不需支付其法术力费用。参见规则[702.170](/cr/7/#cr702-170)，“设谋”。   
...
### <span id='摄食'>摄食</span> / <span id='Ingest'>Ingest</span>
一个关键字异能，可以放逐牌手的牌库顶牌。参见规则[702.115](/cr/7/#cr702-115)，“摄食”。   
A keyword ability that can exile the top card of a player’s library. See rule 702.115, “Ingest.”

### <span id='神器'>神器</span> / <span id='Artifact'>Artifact</span>
一种牌张类别。神器是永久物。参见规则[301](/cr/3/#cr301)，“神器”。   
A card type. An artifact is a permanent. See rule 301, “Artifacts.”

### <span id='神器地'>神器地</span> / <span id='Artifact Land'>Artifact Land</span>
...
### <span id='神器类别'>神器类别</span> / <span id='Artifact Type'>Artifact Type</span>
...
### <span id='神器生物'>神器生物</span> / <span id='Artifact Creature'>Artifact Creature</span>
...
### <span id='深入[特性]'>深入[特性]</span> / <span id='Venture into [Quality]'>Venture into [Quality]</span>
...
### <span id='深入地城'>深入地城</span> / <span id='Venture into the Dungeon'>Venture into the Dungeon</span>
...
### <span id='身世'>身世</span> / <span id='Background'>Background</span>
...
### <span id='神授'>神授</span> / <span id='Bestow'>Bestow</span>
...
### <span id='升级'>升级</span> / <span id='Level Up'>Level Up</span>
一个关键字异能，在生物上放置等级指示物。参见规则[702.87](/cr/7/#cr702-87)，“升级”。关于职业牌的职业等级异能，参见规则[716](/cr/7/#cr716)，“职业牌”。   
...
### <span id='升级牌'>升级牌</span> / <span id='Leveler Cards'>Leveler Cards</span>
具有条状文字栏以及三个力量/防御力方格的牌。参见规则[711](/cr/7/#cr711)，“升级牌”。   
Cards with striated text boxes and three power/toughness boxes. See rule 711, “Leveler Cards.”

### <span id='生命修正'>生命修正</span> / <span id='Life Modifier'>Life Modifier</span>
一个只有先锋牌才有的特征。参见规则[212](/cr/2/#cr212)，“生命修正”。   
A characteristic that only vanguards have. See rule 212, “Life Modifier.”

### <span id='生命，总生命'>生命，总生命</span> / <span id='Life, Life Total'>Life, Life Total</span>
每位牌手都具有一定数量的“生命”，表示该牌手的“总生命”。生命可以得到或失去。参见规则[119](/cr/1/#cr119)，“生命”。   
Each player has an amount of “life,” represented by that player’s “life total.” Life may be gained or lost. See rule 119, “Life.”

### <span id='生物'>生物</span> / <span id='Creature'>Creature</span>
一种牌张类别。生物是永久物。参见规则[302](/cr/3/#cr302)，“生物”。   
A card type. A creature is a permanent. See rule 302, “Creatures.”

### <span id='生物类别'>生物类别</span> / <span id='Creature Type'>Creature Type</span>
...
### <span id='示范'>示范</span> / <span id='Demonstrate'>Demonstrate</span>
...
### <span id='施放'>施放</span> / <span id='Cast'>Cast</span>
...
### <span id='施放费用（已废止）'>施放费用（已废止）</span> / <span id='Casting Cost (Obsolete)'>Casting Cost (Obsolete)</span>
...
一个关键字异能，让你可以从你的坟墓场中放逐一张生物牌来在一个生物上放置+1/+1指示物。参见规则[702.97](/cr/7/#cr702-97)，“食腐”。   
...
### <span id='史迹'>史迹</span> / <span id='Historic'>Historic</span>
如果一个物件具有传奇此超类别、或具有神器此牌张类别、或具有传纪此副类别，它便是史迹。参见规则[700.6](/cr/7/#cr700-6)。   
An object is historic if it has the legendary supertype, the artifact card type, or the Saga subtype. See rule 700.6.

### <span id='事件'>事件</span> / <span id='Event'>Event</span>
游戏中发生的任何事。参见规则[700.1](/cr/7/#cr700-1)。   
Anything that happens in a game. See rule 700.1.

### <span id='时间旅行'>时间旅行</span> / <span id='Time Travel'>Time Travel</span>
...
### <span id='时间跳跃'>时间跳跃</span> / <span id='Phasing'>Phasing</span>
一个关键字异能，使得永久物有时被视为其不存在。参见规则[702.26](/cr/7/#cr702-26)，“时间跳跃”。   
A keyword ability that causes a permanent to sometimes be treated as though it does not exist. See rule 702.26, “Phasing.”

### <span id='时间印记顺序'>时间印记顺序</span> / <span id='Timestamp Order'>Timestamp Order</span>
用来决定同一层或副层中持续性效应生效顺序的系统。参见规则[613.7](/cr/6/#cr613-7)。另参见从属关系。   
...
### <span id='时空'>时空</span> / <span id='Plane'>Plane</span>
一种牌张类别，只在竞逐时空休闲式玩法中使用的非传统万智牌上出现。时空牌不是永久物。参见规则[311](/cr/3/#cr311)，“时空”。   
...
竞逐时空休闲式玩法需要的至少十张时空牌组成的套牌。参见规则[901.3](/cr/9/#cr901-3)。   
A deck of at least ten plane cards needed to play the Planechase casual variant. See rule 901.3.

### <span id='时空骰'>时空骰</span> / <span id='Planar Die'>Planar Die</span>
竞逐时空休闲式玩法需要的特制六面骰。参见规则[901.3](/cr/9/#cr901-3)。   
A specialized six-sided die needed to play the Planechase casual variant. See rule 901.3.

### <span id='食品衍生物'>食品衍生物</span> / <span id='Food Token'>Food Token</span>
...
### <span id='视为（已废止）'>视为（已废止）</span> / <span id='Counts As (Obsolete)'>Counts As (Obsolete)</span>
...
### <span id='尸行者衍生物'>尸行者衍生物</span> / <span id='Walker Token'>Walker Token</span>
尸行者衍生物是名为尸行者的2/2黑色灵俑衍生生物。欲知关于预定义衍生物的更多信息，参见规则[111.10](/cr/1/#cr111-10)。   
...
### <span id='嗜血'>嗜血</span> / <span id='Bloodthirst'>Bloodthirst</span>
...
### <span id='使用/场上（译者注：这两个词在英文原文中相同）'>使用/场上（译者注：这两个词在英文原文中相同）</span> / <span id='Play'>Play</span>
1. 使用一张地是指将一张地作为特殊动作放进战场。参见规则[116](/cr/1/#cr116)，“特殊动作”，和规则[305](/cr/3/#cr305)，“地”。   
...
2. 使用一张牌是指使用地或施放咒语，依该牌的牌张类别而定。参见规则[601](/cr/6/#cr601)，“施放咒语”。   
...
### <span id='试作'>试作</span> / <span id='Prototype'>Prototype</span>
一个异能，允许一张试作牌使用其第二组特征来施放。参见规则[718](/cr/7/#cr718)，“试作牌”，及规则[702.160](/cr/7/#cr702-160)，“试作”。   
...
### <span id='试作牌'>试作牌</span> / <span id='Prototype Card'>Prototype Card</span>
一张分为两部分（且其中一部分是嵌在类别栏下方）的牌。参见规则[718](/cr/7/#cr718)，“试作牌”。   
...
### <span id='守护'>守护</span> / <span id='Ward'>Ward</span>
...
### <span id='收集编号'>收集编号</span> / <span id='Collector Number'>Collector Number</span>
...
### <span id='守军'>守军</span> / <span id='Defender'>Defender</span>
...
### <span id='手牌'>手牌</span> / <span id='Hand'>Hand</span>
...
参见规则[402](/cr/4/#cr402)，“手牌”。   
See rule 402, “Hand.”

### <span id='手牌上限'>手牌上限</span> / <span id='Maximum Hand Size'>Maximum Hand Size</span>
牌手必须于清除阶段中将多余的牌弃掉，直到手牌的数量少于或等于该数字。参见规则[402.2](/cr/4/#cr402-2)和[514.1](/cr/5/#cr514-1)。   
...
### <span id='树林行者'>树林行者</span> / <span id='Forestwalk'>Forestwalk</span>
参见地行者。   
See Landwalk.

### <span id='输去游戏'>输去游戏</span> / <span id='Lose the Game'>Lose the Game</span>
...
### <span id='双头巨人玩法'>双头巨人玩法</span> / <span id='Two-Headed Giant Variant'>Two-Headed Giant Variant</span>
一个多人玩法，在两人共享总生命且同时进行回合的队伍之间展开。参见规则[801](/cr/8/#cr801)，“双头巨人玩法”。   
...
### <span id='瞬间'>瞬间</span> / <span id='Instant'>Instant</span>
一种牌张类别。瞬间不是永久物。参见规则[304](/cr/3/#cr304)，“瞬间”。   
A card type. An instant is not a permanent. See rule 304, “Instants.”

### <span id='死触'>死触</span> / <span id='Deathtouch'>Deathtouch</span>
...
### <span id='伺机'>伺机</span> / <span id='Prowl'>Prowl</span>
一个关键字异能，有时允许咒语以替代性费用施放。参见规则[702.76](/cr/7/#cr702-76)，“伺机”。   
A keyword ability that may allow a spell to be cast for an alternative cost. See rule 702.76, “Prowl.”

### <span id='死去'>死去</span> / <span id='Dies'>Dies</span>
...
### <span id='颂威'>颂威</span> / <span id='Exalted'>Exalted</span>
一个关键字异能，让生物在战斗中更好。参见规则[702.83](/cr/7/#cr702-83)，“颂威”。   
A keyword ability that can make a creature better in combat. See rule 702.83, “Exalted.”

### <span id='搜寻'>搜寻</span> / <span id='Search'>Search</span>
...
速度是牌手可具有的数值。参见规则[702.179](/cr/7/#cr702-179)，“发动引擎！”。   
...
1. 如果某牌手的速度达到4，则其便达到速度极限。参见规则[702.179](/cr/7/#cr702-179)，“发动引擎！”。   
1. A player has max speed if their speed is 4. See rule 702.179, “Start Your Engines!”

2. 一个关键字异能，赋予永久物或牌一个异能，该异能仅在该永久物的操控者（或该牌的拥有者，如果它不在战场上）的速度4时生效。参见规则[702.178](/cr/7/#cr702-178)，“速度极限”。   
...
## T
### <span id='太空塑师'>太空塑师</span> / <span id='Space Sculptor'>Space Sculptor</span>
一个关键字异能，将战场上的生物分为不同星区。参见规则[702.158](/cr/7/#cr702-158)，“太空塑师”。   
A keyword ability that splits creatures on the battlefield into sectors. See rule 702.158, “Space Sculptor.”

### <span id='探查'>探查</span> / <span id='Investigate'>Investigate</span>
...
### <span id='探地器衍生物'>探地器衍生物</span> / <span id='Lander Token'>Lander Token</span>
...
### <span id='贪食'>贪食</span> / <span id='Ravenous'>Ravenous</span>
一个关键字异能，见于一些法术力费用中含有{X}的生物牌上。该生物进战场时上面有X个+1/+1指示物，且如果X等于或大于5，你抓一张牌。参见规则[702.156](/cr/7/#cr702-156)，“贪食”。   
...
### <span id='套件'>套件</span> / <span id='Modular'>Modular</span>
一个关键字异能，使得永久物进战场时带有+1/+1指示物，且能将这些指示物移动到其他神器生物上。参见规则[702.43](/cr/7/#cr702-43)，“套件”。   
...
### <span id='套牌'>套牌</span> / <span id='Deck'>Deck</span>
...
### <span id='替代性效应'>替代性效应</span> / <span id='Replacement Effect'>Replacement Effect</span>
持续性效应的一种，注意某特定事件将发生，并且将该事件完全或部分的用不同的事件替代。参见规则[614](/cr/6/#cr614)，“替代性效应”。   
...
### <span id='替身甲（已废止）'>替身甲（已废止）</span> / <span id='Totem Armor (Obsolete)'>Totem Armor (Obsolete)</span>
一个已废止的关键字异能，已被重新命名。参见规则[702.89](/cr/7/#cr702-89)，“本影甲”。   
An obsolete keyword ability that has been renamed. See rule 702.89, “Umbra Armor.”

### <span id='提示文字'>提示文字</span> / <span id='Reminder Text'>Reminder Text</span>
牌的文字栏内括号中的斜体字，总结对该牌生效的一条规则，但不是正式规则叙述且对游戏没有效应。参见规则[207.2](/cr/2/#cr207-2)。   
...
### <span id='挑拨'>挑拨</span> / <span id='Provoke'>Provoke</span>
一个关键字异能，可以迫使生物进行阻挡。参见规则[702.39](/cr/7/#cr702-39)，“挑拨”。   
A keyword ability that can force a creature to block. See rule 702.39, “Provoke.”

### <span id='跳读'>跳读</span> / <span id='Read Ahead'>Read Ahead</span>
一个见于传纪上的关键字异能，允许其操控者选择从哪个章节开始。参见规则[702.155](/cr/7/#cr702-155)，“跳读”。   
...
### <span id='贴附'>贴附</span> / <span id='Attach'>Attach</span>
...
### <span id='贴纸'>贴纸</span> / <span id='Sticker'>Sticker</span>
一个置于物件或牌手上的标示物，影响其特征或与规则或效应互动。参见规则[123](/cr/1/#cr123)，“贴纸”。   
A marker placed on an object that modifies its characteristics or interacts with a rule or effect. See rule 123, “Stickers.”

### <span id='贴纸卡'>贴纸卡</span> / <span id='Sticker Sheet'>Sticker Sheet</span>
...
一个关键字异能，让牌手将牌的规则叙述附加到另一个咒语上。参见规则[702.47](/cr/7/#cr702-47)，“通联”。   
A keyword ability that lets a player add a card’s rules text onto another spell. See rule 702.47, “Splice.”

### <span id='统帅区'>统帅区</span> / <span id='Command'>Command</span>
...
### <span id='投票'>投票</span> / <span id='Vote'>Vote</span>
...
### <span id='图片'>图片</span> / <span id='Illustration'>Illustration</span>
印在牌上面一半的图片，对游戏没有效应。参见规则[203](/cr/2/#cr203)，“图片”。   
A picture printed on the upper half of a card that has no effect on game play. See rule 203, “Illustration.”

### <span id='图片画家的名字'>图片画家的名字</span> / <span id='Illustration Credit'>Illustration Credit</span>
在文字栏下方印的信息，对游戏没有效应。参见规则[213](/cr/2/#cr213)，“文字栏下方信息”。   
Information printed directly below the text box that has no effect on game play. See rule 213, “Information Below the Text Box.”

### <span id='吞噬'>吞噬</span> / <span id='Devour'>Devour</span>
...
### <span id='脱缰'>脱缰</span> / <span id='Unleash'>Unleash</span>
一个关键字异能，让生物进入战场时具有+1/+1指示物，并且如果它具有+1/+1指示物则防止其阻挡。参见规则[702.98](/cr/7/#cr702-98)，“脱缰”。   
...
## W
### <span id='完成地城'>完成地城</span> / <span id='Complete a Dungeon'>Complete a Dungeon</span>
...
### <span id='玩法'>玩法</span> / <span id='Variant'>Variant</span>
决定一盘多人游戏风格的一组规则集合。参见规则[800.2](/cr/8/#cr800-2)。   
An additional set of rules that determines the style of a multiplayer game. See rule 800.2.

### <span id='完化'>完化</span> / <span id='Compleated'>Compleated</span>
...
### <span id='往生'>往生</span> / <span id='Afterlife'>Afterlife</span>
...
### <span id='未倒转'>未倒转</span> / <span id='Unflipped'>Unflipped</span>
一个永久物可能具有的默认状态。参见规则[110.5](/cr/1/#cr110-5)和规则[710](/cr/7/#cr710)，“倒转牌”。另参见倒转。   
...
### <span id='未横置'>未横置</span> / <span id='Untapped'>Untapped</span>
...
一个关键字异能，让永久物或牌手避免成为目标。参见规则[702.18](/cr/7/#cr702-18)，“帷幕”。   
...
### <span id='温习'>温习</span> / <span id='Learn'>Learn</span>
...
### <span id='文字栏'>文字栏</span> / <span id='Text Box'>Text Box</span>
牌的一部分。文字栏印在牌的下面一半，包括该牌的规则叙述、提示文字、和背景叙述。参见规则[207](/cr/2/#cr207)，“文字栏”。   
...
### <span id='物件'>物件</span> / <span id='Object'>Object</span>
堆叠上的异能、牌、牌的复制品、衍生物、咒语或永久物。参见规则[109](/cr/1/#cr109)，“物件”。   
An ability on the stack, a card, a copy of a card, an emblem, a token, a spell, or a permanent. See rule 109, “Objects.”

### <span id='武具'>武具</span> / <span id='Equipment'>Equipment</span>
...
### <span id='无色'>无色</span> / <span id='Color Identity'>Color Identity</span>
...
一个关键字异能，让牌手得到生命。参见规则[702.15](/cr/7/#cr702-15)，“系命”。   
A keyword ability that causes a player to gain life. See rule 702.15, “Lifelink.”

### <span id='洗牌'>洗牌</span> / <span id='Shuffle'>Shuffle</span>
...
### <span id='牺牲'>牺牲</span> / <span id='Sacrifice'>Sacrifice</span>
...
### <span id='下毒'>下毒</span> / <span id='Toxic'>Toxic</span>
一个关键字异能，使牌手因具有此异能的生物造成的战斗伤害获得中毒指示物。参见规则[702.164](/cr/7/#cr702-164)，“下毒”。   
...
### <span id='先锋'>先锋</span> / <span id='Vanguard'>Vanguard</span>
...
2. 一种牌张类别，只在先锋休闲式玩法中使用的非传统万智牌上出现。先锋牌不是永久物。参见规则[313](/cr/3/#cr313)，“先锋”。   
...
### <span id='先攻'>先攻</span> / <span id='First Strike'>First Strike</span>
一个关键字异能，让生物在其他生物之前造成其战斗伤害。参见规则[702.7](/cr/7/#cr702-7)，“先攻”。   
A keyword ability that lets a creature deal its combat damage before other creatures. See rule 702.7, “First Strike.”

### <span id='显化'>显化</span> / <span id='Manifest'>Manifest</span>
...
### <span id='显化惧象'>显化惧象</span> / <span id='Manifest Dread'>Manifest Dread</span>
...
### <span id='献祭'>献祭</span> / <span id='Offering'>Offering</span>
一个关键字异能，影响你何时施放咒语以及所需要花费的法术力数量。参见规则[702.48](/cr/7/#cr702-48)，“献祭”。   
...
### <span id='献力'>献力</span> / <span id='Devotion'>Devotion</span>
...
### <span id='先手队伍'>先手队伍</span> / <span id='Starting Team'>Starting Team</span>
在使用队伍共享回合模式中，选择进行游戏第一个回合的队伍。参见规则[103.1](/cr/1/#cr103-1)。   
The team chosen to take the first turn of a game using the shared team turns option. See rule 103.1.

### <span id='先手牌手'>先手牌手</span> / <span id='Starting Player'>Starting Player</span>
选择进行游戏第一个回合的牌手。参见规则[103.1](/cr/1/#cr103-1)。   
The player chosen to take the first turn of a game. See rule 103.1.

### <span id='线索衍生物'>线索衍生物</span> / <span id='Clue Token'>Clue Token</span>
...
### <span id='先制'>先制</span> / <span id='Initiative'>Initiative</span>
...
### <span id='限制'>限制</span> / <span id='Restriction'>Restriction</span>
一个阻止一个或数个生物攻击或阻挡的效应。参见规则[508.1c](/cr/5/#cr508-1c)以及[509.1b](/cr/5/#cr509-1b)。   
An effect that precludes one or more creatures from attacking or blocking. See rules 508.1c and 509.1b.

### <span id='限制赛'>限制赛</span> / <span id='Limited'>Limited</span>
一种玩法，每位牌手得到一定数量的未开封万智牌产品，并用它们创造自己的套牌。参见规则[100.2](/cr/1/#cr100-2)。   
...
### <span id='限制影响范围模式'>限制影响范围模式</span> / <span id='Limited Range of Influence'>Limited Range of Influence</span>
在一些多人游戏中使用的可选规则，限制牌手能够影响的事物。参见规则[801](/cr/8/#cr801)，“限制影响范围模式”。   
...
### <span id='响应'>响应</span> / <span id='Restart the Game'>Restart the Game</span>
...
### <span id='小队'>小队</span> / <span id='Squad'>Squad</span>
一个关键字异能，使生物进战场时派出其复制品。参见规则[702.157](/cr/7/#cr702-157)，“小队”。   
A keyword ability that creates copies of a creature when it enters the battlefield. See rule 702.157, “Squad.”

### <span id='消灭'>消灭</span> / <span id='Destroy'>Destroy</span>
...
### <span id='消逝'>消逝</span> / <span id='Vanishing'>Vanishing</span>
一个关键字异能，限制一个永久物在战场上的时间。参见规则[702.63](/cr/7/#cr702-63)，“消逝”。   
A keyword ability that limits how long a permanent remains on the battlefield. See rule 702.63, “Vanishing.”

### <span id='消退'>消退</span> / <span id='Fading'>Fading</span>
一个关键字异能，限制一个永久物能够留在战场上的时间。参见规则[702.32](/cr/7/#cr702-32)，“消退”。   
A keyword ability that limits how long a permanent remains on the battlefield. See rule 702.32, “Fading.”

### <span id='效应'>效应</span> / <span id='Effect'>Effect</span>
...
### <span id='邪计'>邪计</span> / <span id='Scheme'>Scheme</span>
一种牌张类别，只在魔王休闲式玩法中使用的非传统万智牌上出现。邪计牌不是永久物。参见规则[314](/cr/3/#cr314)，“邪计”。   
...
### <span id='邪计套牌'>邪计套牌</span> / <span id='Scheme Deck'>Scheme Deck</span>
魔王休闲式玩法需要的至少二十张邪计牌组成的套牌。参见规则[904.3](/cr/9/#cr904-3)。   
A deck of at least twenty scheme cards needed to play the Archenemy casual variant. See rule 904.3.

### <span id='协力'>协力</span> / <span id='Conspire'>Conspire</span>
一个关键字异能，让生物可以复制咒语。参见规则[702.78](/cr/7/#cr702-78)，“协力”。   
A keyword ability that creates a copy of a spell. See rule 702.78, “Conspire.”

### <span id='谐颂'>谐颂</span> / <span id='Harmonize'>Harmonize</span>
一个关键字异能，让牌手能支付特定费用从其坟墓场中施放牌，且能横置由其操控的生物来减少该费用。参见规则[702.180](/cr/7/#cr702-180)，“谐颂”。   
...
### <span id='卸装'>卸装</span> / <span id='Unattach'>Unattach</span>
将一个武具从其所贴附的生物上移走，从而让武具留在战场上但不装备在任何生物上。参见规则[701.3d](/cr/7/#cr701-3d)。   
...
### <span id='行动阶段'>行动阶段</span> / <span id='Main Phase'>Main Phase</span>
回合的一部分。第一个行动阶段，或战斗前行动阶段，是回合中的第二个阶段。第二个行动阶段，或战斗后行动阶段，是回合中的第四个阶段。参见规则[505](/cr/5/#cr505)，“行动阶段”。   
...
### <span id='行侣'>行侣</span> / <span id='Companion'>Companion</span>
...
### <span id='醒转'>醒转</span> / <span id='Awaken'>Awaken</span>
...
### <span id='虚色'>虚色</span> / <span id='Devoid'>Devoid</span>
...
### <span id='蓄势'>蓄势</span> / <span id='Station'>Station</span>
...
### <span id='蓄势牌'>蓄势牌</span> / <span id='Station Cards'>Station Cards</span>
...
### <span id='续战'>续战</span> / <span id='Endure'>Endure</span>
...
### <span id='宣告攻击者'>宣告攻击者</span> / <span id='Declare Attackers'>Declare Attackers</span>
...
### <span id='宣告攻击者步骤'>宣告攻击者步骤</span> / <span id='Declare Attackers Step'>Declare Attackers Step</span>
...
### <span id='宣告阻挡者'>宣告阻挡者</span> / <span id='Declare Blockers'>Declare Blockers</span>
...
### <span id='宣告阻挡者步骤'>宣告阻挡者步骤</span> / <span id='Declare Blockers Step'>Declare Blockers Step</span>
...
### <span id='血滴衍生物'>血滴衍生物</span> / <span id='Blood Token'>Blood Token</span>
...
### <span id='雪境'>雪境</span> / <span id='Snow'>Snow</span>
一般只对永久物有关的超类别。参见规则[205.4](/cr/2/#cr205-4)，“超类别”。   
A supertype that’s normally relevant on permanents. See rule 205.4, “Supertypes.”

### <span id='雪境法术力符号'>雪境法术力符号</span> / <span id='Snow Mana Symbol'>Snow Mana Symbol</span>
雪境法术力符号{S}表示一点可以由雪境来源所产生的法术力所支付的费用。它也可以表示用于支付费用的、由雪境来源所产生的法术力。参见规则[107.4h](/cr/1/#cr107-4h)。   
...
### <span id='训导'>训导</span> / <span id='Mentor'>Mentor</span>
一个关键字异能，使你的较大生物在与较小生物一同攻击时强化后者。参见规则[702.134](/cr/7/#cr702-134)，“训导”。   
...
### <span id='循环法术师'>循环法术师</span> / <span id='Wizardcycling'>Wizardcycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环海岛'>循环海岛</span> / <span id='Islandcycling'>Islandcycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环基本地'>循环基本地</span> / <span id='Basic Land Type'>Basic Land Type</span>
参见类别循环。   
...
### <span id='循环裂片妖'>循环裂片妖</span> / <span id='Slivercycling'>Slivercycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环山脉'>循环山脉</span> / <span id='Mountaincycling'>Mountaincycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环树林'>循环树林</span> / <span id='Forestcycling'>Forestcycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环沼泽'>循环沼泽</span> / <span id='Swampcycling'>Swampcycling</span>
参见类别循环。   
See Typecycling.

### <span id='循环（动作）'>循环（动作）</span> / <span id='Loop'>Loop</span>
一系列可以重复无数次的动作。参见规则[731](/cr/7/#cr731)，“进行简化”。   
A set of actions that could be repeated indefinitely. See rule 732, “Taking Shortcuts.”

### <span id='循环（异能）'>循环（异能）</span> / <span id='Cycling'>Cycling</span>
...
## Y
### <span id='压印'>压印</span> / <span id='Imprint'>Imprint</span>
...
### <span id='掩蔽'>掩蔽</span> / <span id='Hideaway'>Hideaway</span>
一个关键字异能，让牌手藏起一张秘密的牌。参见规则[702.75](/cr/7/#cr702-75)，“掩蔽”。   
A keyword ability that lets a player store a secret card. See rule 702.75, “Hideaway.”

### <span id='延迟触发式异能'>延迟触发式异能</span> / <span id='Delayed Triggered Ability'>Delayed Triggered Ability</span>
...
### <span id='演化'>演化</span> / <span id='Adapt'>Adapt</span>
...
### <span id='延缓'>延缓</span> / <span id='Suspend'>Suspend</span>
一个关键字异能，提供使用一张牌的其他途径。参见规则[702.62](/cr/7/#cr702-62)，“延缓”。如果一张牌在放逐区、具有延缓、并且具有计时指示物，则该牌“已延缓”。   
...
### <span id='颜色'>颜色</span> / <span id='Color'>Color</span>
...
### <span id='延生'>延生</span> / <span id='Outlast'>Outlast</span>
一个关键字异能，让生物能够持续变大。参见规则[702.107](/cr/7/#cr702-107)，“延生”。   
A keyword ability that allows a creature to grow larger over time. See rule 702.107, “Outlast.”

### <span id='衍生物'>衍生物</span> / <span id='Token'>Token</span>
一个标记，用来表示任何不用牌来表示的永久物。参见规则[111](/cr/1/#cr111)，“衍生物”。   
A marker used to represent any permanent that isn’t represented by a card. See rule 111, “Tokens.”

### <span id='延势'>延势</span> / <span id='Reach'>Reach</span>
一个关键字异能，让生物可以阻挡具有飞行的攻击生物。参见规则[702.17](/cr/7/#cr702-17)，“延势”。另参见飞行。   
...
### <span id='掩袭'>掩袭</span> / <span id='Dash'>Dash</span>
...
### <span id='要求'>要求</span> / <span id='Requirement'>Requirement</span>
一个强制一个或数个生物攻击或阻挡的效应。参见规则[508.1d](/cr/5/#cr508-1d)以及[509.1c](/cr/5/#cr509-1c)。   
An effect that forces one or more creatures to attack or block. See rules 508.1d and 509.1c.

### <span id='夜形'>夜形</span> / <span id='Nightbound'>Nightbound</span>
...
### <span id='一般法术力'>一般法术力</span> / <span id='Generic Mana'>Generic Mana</span>
一般法术力指没有被有色法术力符号表示的费用；它可以被任何类别的法术力支付。参见规则[107.4](/cr/1/#cr107-4)。   
...
### <span id='已备法'>已备法</span> / <span id='Prepared'>Prepared</span>
...
### <span id='已撤法'>已撤法</span> / <span id='Unprepared'>Unprepared</span>
...
### <span id='已乘驾'>已乘驾</span> / <span id='Saddled'>Saddled</span>
一个生物可在其乘驾异能结算时得到的称号。参见规则[702.171](/cr/7/#cr702-171)，“乘驾”。   
A designation given to a creature whose saddle ability has resolved. See rule 702.171, “Saddle.”

### <span id='移出游戏，移除，移出游戏区（已废止）'>移出游戏，移除，移出游戏区（已废止）</span> / <span id='Remove from the Game, Removed, Removed-from-the-Game Zone (Obsolete)'>Remove from the Game, Removed, Removed-from-the-Game Zone (Obsolete)</span>
...
### <span id='移出战斗'>移出战斗</span> / <span id='Remove from Combat'>Remove from Combat</span>
...
### <span id='依次让过'>依次让过</span> / <span id='Pass in Succession'>Pass in Succession</span>
如果游戏中的每位牌手（从任意一人开始）在得到优先权时都不执行动作，所有牌手便“依次让过”。参见规则[117](/cr/1/#cr117)，“时机和优先权”。   
...
### <span id='一次性效应'>一次性效应</span> / <span id='One-Shot Effect'>One-Shot Effect</span>
只作一件事且没有持续的效应。参见规则[610](/cr/6/#cr610)，“一次性效应”。另参见持续性效应。   
...
### <span id='遗存'>遗存</span> / <span id='Embalm'>Embalm</span>
...
### <span id='已倒转'>已倒转</span> / <span id='Flipped'>Flipped</span>
一个永久物可能具有的状态。参见规则[110.5](/cr/1/#cr110-5)以及规则[710](/cr/7/#cr710)，“倒转牌”。另参见未倒转。   
A status a permanent may have. See rule 110.5 and rule 710, “Flip Cards.” See also Unflipped.

### <span id='移动'>移动</span> / <span id='Move'>Move</span>
从一个物件上移除指示物，并将其放置在另一个物件上。参见规则[122.5](/cr/1/#cr122-5)。   
To remove a counter from one object and put it on a different object. See rule 122.5.

一些较老的牌使用“移动”一词提及灵气；这些牌在Oracle牌张参考文献中已获得勘误，现在使用“贴附”一词。   
...
### <span id='已横置'>已横置</span> / <span id='Tap Symbol'>Tap Symbol</span>
...
### <span id='已解锁'>已解锁</span> / <span id='Unlocked'>Unlocked</span>
如果一个连体永久物具有特定的解锁称号，则其相应的一边为“已解锁”。参见规则[709.5](/cr/7/#cr709-5)。   
One half of a split permanent is “unlocked” if it has the appropriate unlocked designation. See rule 709.5.

### <span id='已铭勇'>已铭勇</span> / <span id='Renowned'>Renowned</span>
因永久物的铭勇异能，而赋予它的一种称号。参见规则[702.112](/cr/7/#cr702-112)，“铭勇”。   
A designation given to a permanent as a result of the renown ability. See rule 702.112, “Renown.”

### <span id='异能'>异能</span> / <span id='Ability'>Ability</span>
...
### <span id='异能的来源'>异能的来源</span> / <span id='Source of an Ability'>Source of an Ability</span>
创造该异能的物件。参见规则[113.7](/cr/1/#cr113-7)。   
The object that generated that ability. See rule 113.7.

### <span id='异能提示'>异能提示</span> / <span id='Ability Word'>Ability Word</span>
...
### <span id='已煽惑'>已煽惑</span> / <span id='Goaded'>Goaded</span>
...
### <span id='已上锁'>已上锁</span> / <span id='Locked'>Locked</span>
如果一个连体永久物不具有特定的解锁称号，则其相应的一边为“已上锁”。参见规则[709.5](/cr/7/#cr709-5)。   
One half of a split permanent is “locked” if it doesn’t have the appropriate unlocked designation. See rule 709.5.

### <span id='已设谋'>已设谋</span> / <span id='Plotted'>Plotted</span>
以设谋特殊动作放逐的牌成为已设谋。其他效应亦能令一张已放逐的牌成为已设谋。参见规则[702.170](/cr/7/#cr702-170)，“设谋”。   
...
### <span id='逸脱'>逸脱</span> / <span id='Escape'>Escape</span>
...
### <span id='异象'>异象</span> / <span id='Phenomenon'>Phenomenon</span>
只出现在非传统万智牌上的一种牌张类别，在竞逐时空休闲式玩法中使用。参见规则[312](/cr/3/#cr312)，“异象”。   
...
### <span id='易形'>易形</span> / <span id='Transfigure'>Transfigure</span>
一个关键字异能，让牌手可以从其牌库中搜寻一张代替的生物牌。参见规则[702.71](/cr/7/#cr702-71)，“易形”。   
A keyword ability that lets a player search their library for a replacement creature card. See rule 702.71, “Transfigure.”

### <span id='义勇'>义勇</span> / <span id='Dethrone'>Dethrone</span>
...
### <span id='已预示'>已预示</span> / <span id='Foretold'>Foretold</span>
使用预示此特殊动作被放逐的牌成为已预示。其他效应也可以使一张被放逐的牌成为已预示。如果一个咒语在被施放之前是一张放逐区中已预示的牌，则该咒语为已预示。   
...
### <span id='已跃回，已跃离'>已跃回，已跃离</span> / <span id='Phased In, Phased Out'>Phased In, Phased Out</span>
永久物可能具有的状态。默认状态下，永久物都是已跃回。已跃离的永久物被视为其不存在。参见规则[110.5](/cr/1/#cr110-5)和规则[702.26](/cr/7/#cr702-26)，“时间跳跃”。（“跃离区”在较老版本的规则中是一个游戏区域。）   
...
### <span id='已侦结/侦结'>已侦结/侦结</span> / <span id='Solved'>Solved</span>
1. 一个案件可以获得的称号，允许案件的最后一个异能影响游戏。参见规则[719](/cr/7/#cr719)，“案件牌”。   
1. A designation a Case may have, allowing its last ability to affect the game. See rule 719, “Case Cards.”

2. 一个案件的关键字异能，在案件具有已侦结此称号时影响游戏。参见规则[702.169](/cr/7/#cr702-169)，“侦结”。   
...
### <span id='易质'>易质</span> / <span id='Transmute'>Transmute</span>
一个关键字异能，让牌手从其牌库中搜寻一张代替的牌。参见规则[702.53](/cr/7/#cr702-53)，“易质”。   
A keyword ability that lets a player search their library for a replacement card. See rule 702.53, “Transmute.”

### <span id='已中毒'>已中毒</span> / <span id='Poisoned'>Poisoned</span>
具有一个或数个中毒指示物。参见规则[122](/cr/1/#cr122)，“指示物”。   
Having one or more poison counters. See rule 122, “Counters.”

### <span id='以“若”开头的子句'>以“若”开头的子句</span> / <span id='Intervening “If” Clause'>Intervening “If” Clause</span>
一个特别用词的条件，检查一个触发式异能是否会触发，并且在将结算时再次检查。参见规则[603.4](/cr/6/#cr603-4)。   
A specially worded condition checked as a triggered ability would trigger and again as it would resolve. See rule 603.4.

### <span id='银边'>银边</span> / <span id='Silver-Bordered'>Silver-Bordered</span>
一些系列中的卡牌和一些赠卡以银色边框印刷。银边牌张用于休闲游戏，可能具有本文件中之规则未涵盖的特性及叙述。   
...
### <span id='隐藏区域'>隐藏区域</span> / <span id='Hidden Zone'>Hidden Zone</span>
不是所有牌手都应该可以看到牌面的区域。参见规则[400.2](/cr/4/#cr400-2)。另参见公开区域。   
...
### <span id='永久地（已废止）'>永久地（已废止）</span> / <span id='Permanently (Obsolete)'>Permanently (Obsolete)</span>
一个已废止的用词，指示一个持续性效应没有时限，并延续直到此盘游戏结束。具有此用词的牌在Oracle牌张参考文献中已获得勘误，并删去此用词。   
...
### <span id='永久物'>永久物</span> / <span id='Permanent'>Permanent</span>
战场上的牌或衍生物。参见规则[110](/cr/1/#cr110)，“永久物”。   
A card or token on the battlefield. See rule 110, “Permanents.”

### <span id='永久物牌'>永久物牌</span> / <span id='Permanent Card'>Permanent Card</span>
可以放进战场的牌。参见规则[110.4a](/cr/1/#cr110-4a)。   
A card that could be put onto the battlefield. See rule 110.4a.

### <span id='永久物咒语'>永久物咒语</span> / <span id='Permanent Spell'>Permanent Spell</span>
结算时会作为永久物进入战场的咒语。参见规则[110.4b](/cr/1/#cr110-4b)。   
A spell that will enter the battlefield as a permanent as part of its resolution. See rule 110.4b.

### <span id='永生'>永生</span> / <span id='Eternalize'>Eternalize</span>
一个关键字异能，使牌手从其坟墓场中放逐一张生物牌，并派出一个该牌的永生衍生物版本。参见规则[702.129](/cr/7/#cr702-129)，“永生”。   
...
### <span id='拥有者'>拥有者</span> / <span id='Owner'>Owner</span>
（作为游戏的一部分）拥有一张牌、永久物、衍生物或咒语的牌手。参见规则[108.3](/cr/1/#cr108-3)、[110.2](/cr/1/#cr110-2)、[111.2](/cr/1/#cr111-2)和[112.2](/cr/1/#cr112-2)。   
The player who (for purposes of the game) a card, permanent, token, or spell belongs to. See rules 108.3, 110.2, 111.2, and 112.2.

### <span id='有饰装的'>有饰装的</span> / <span id='Modified'>Modified</span>
有饰装的生物是指其上有指示物、或佩带有武具、或被一个由其操控者操控的灵气所结附的生物。参见规则[700.9](/cr/7/#cr700-9)。   
...
### <span id='游戏胜利'>游戏胜利</span> / <span id='Win the Game'>Win the Game</span>
有多种方法可以取得游戏的胜利。参见规则[104](/cr/1/#cr104)，“结束游戏”，以及规则[810.8](/cr/8/#cr810-8)（双头巨人游戏的额外规则）和规则[809.5](/cr/8/#cr809-5)（皇帝玩法的额外规则）。   
...
### <span id='游戏之外'>游戏之外</span> / <span id='Outside the Game'>Outside the Game</span>
如果一个物件不在任何游戏区域中，该物件在“游戏之外”。参见规则[400.11](/cr/4/#cr400-11)。   
An object is “outside the game” if it isn’t in any of the game’s zones. See rule 400.11.

### <span id='优先权'>优先权</span> / <span id='Priority'>Priority</span>
...
### <span id='预报'>预报</span> / <span id='Forecast'>Forecast</span>
一个关键字异能，允许从牌手手上起动一个起动式异能。参见规则[702.57](/cr/7/#cr702-57)，“预报”。   
A keyword ability that allows an activated ability to be activated from a player’s hand. See rule 702.57, “Forecast.”

### <span id='预示'>预示</span> / <span id='Foretell'>Foretell</span>
一个关键字异能，使牌手从其手上放逐牌，并在将来的回合中使用替代性费用施放之。参见规则[702.143](/cr/7/#cr702-143)，“预示”。   
...
### <span id='余响'>余响</span> / <span id='Aftermath'>Aftermath</span>
...
### <span id='预兆牌'>预兆牌</span> / <span id='Omen Card'>Omen Card</span>
...
### <span id='远超所见'>远超所见</span> / <span id='More Than Meets the Eye'>More Than Meets the Eye</span>
...
## Z
### <span id='再调度'>再调度</span> / <span id='Mulligan'>Mulligan</span>
执行“再调度”是指不接受一副可能的起手牌，并用一副新的起手牌代替之。参见规则[103.5](/cr/1/#cr103-5)。   
To take a mulligan is to reject a prospective opening hand in favor of a new one. See rule 103.5.

### <span id='在回合结束时（已废止）'>在回合结束时（已废止）</span> / <span id='At End of Turn (Obsolete)'>At End of Turn (Obsolete)</span>
...
### <span id='载具'>载具</span> / <span id='Vehicle'>Vehicle</span>
一个神器副类别。载具可以变成神器生物。参见规则[301](/cr/3/#cr301)，“神器”，以及规则[702.122](/cr/7/#cr702-122)，“搭载”。   
An artifact subtype. Vehicles can become artifact creatures. See rule 301, “Artifacts,” and rule 702.122, “Crew.”

### <span id='再起'>再起</span> / <span id='Jump-Start'>Jump-Start</span>
...
### <span id='造成'>造成</span> / <span id='Deal'>Deal</span>
参见伤害。   
See Damage.

### <span id='造访'>造访</span> / <span id='Visit'>Visit</span>
一个见于景点牌上的关键字异能。它在你掷骰造访景点并获得特定结果时提供效应。参见规则[702.159](/cr/7/#cr702-159)，“造访”。   
...
增幅是一个关键字异能，表示一个选择性的额外费用。如果一个咒语的操控者宣告将支付其任何或所有的增幅费用，则该咒语已增幅。参见规则[702.33](/cr/7/#cr702-33)，“增幅”。   
...
### <span id='增强'>增强</span> / <span id='Amplify'>Amplify</span>
...
### <span id='增效'>增效</span> / <span id='Escalate'>Escalate</span>
...
### <span id='增殖'>增殖</span> / <span id='Proliferate'>Proliferate</span>
...
### <span id='战斗后行动阶段'>战斗后行动阶段</span> / <span id='Postcombat Main Phase'>Postcombat Main Phase</span>
战斗阶段之后的行动阶段。参见行动阶段。   
A main phase that occurs after a combat phase. See Main Phase.

### <span id='战斗阶段'>战斗阶段</span> / <span id='Combat Phase'>Combat Phase</span>
...
### <span id='战斗结束步骤'>战斗结束步骤</span> / <span id='End of Combat Step'>End of Combat Step</span>
...
### <span id='战斗开始步骤'>战斗开始步骤</span> / <span id='Beginning of Combat Step'>Beginning of Combat Step</span>
...
### <span id='战斗前行动阶段'>战斗前行动阶段</span> / <span id='Precombat Main Phase'>Precombat Main Phase</span>
回合中的第一个行动阶段。参见行动阶段。   
The first main phase of a turn. See Main Phase.

### <span id='战斗伤害'>战斗伤害</span> / <span id='Combat Damage'>Combat Damage</span>
...
### <span id='战斗伤害步骤'>战斗伤害步骤</span> / <span id='Combat Damage Step'>Combat Damage Step</span>
...
### <span id='战嚎'>战嚎</span> / <span id='Battle Cry'>Battle Cry</span>
...
### <span id='展示'>展示</span> / <span id='Reveal'>Reveal</span>
...
### <span id='召唤失调规则'>召唤失调规则</span> / <span id='Summoning Sickness Rule'>Summoning Sickness Rule</span>
非正式用语，指除非一个生物在牌手最近的一个回合开始时便已经操控它，否则该牌手不能用该生物进行攻击或起动它包含横置符号或重置符号的起动式异能。参见规则[302.6](/cr/3/#cr302-6)。另参见敏捷。   
...
### <span id='召唤（已废止）'>召唤（已废止）</span> / <span id='Summon (Obsolete)'>Summon (Obsolete)</span>
老生物牌的类别栏上印有“召唤[生物类别]”。这些牌在Oracle牌张参考文献中已得到勘误，改为“生物～[生物类别]”。（这其中很多牌的生物类别也已经更新。）另参见生物。   
...
### <span id='召集'>召集</span> / <span id='Convoke'>Convoke</span>
...
### <span id='爪印符号'>爪印符号</span> / <span id='Pawprint Symbol'>Pawprint Symbol</span>
一个形状像爪印的符号，在某些具有模式的咒语中用于指示模式。参见规则[700.2i](/cr/7/#cr700-2i)。   
A symbol shaped like a pawprint that is used to indicate the modes on some modal spells. See rule 700.2i.

### <span id='沼泽'>沼泽</span> / <span id='Swamp'>Swamp</span>
五种基本地类别中的一种。任何具有此副类别的地都具有异能“{T}：加{B}。”参见规则[305.6](/cr/3/#cr305-6)。   
One of the five basic land types. Any land with this subtype has the ability “{T}: Add {B}.” See rule 305.6.

### <span id='沼泽行者'>沼泽行者</span> / <span id='Swampwalk'>Swampwalk</span>
参见地行者。   
See Landwalk.

### <span id='折磨'>折磨</span> / <span id='Afflict'>Afflict</span>
...
### <span id='支付'>支付</span> / <span id='Pay'>Pay</span>
当游戏产生费用要求时，执行满足要求的动作。这通常意味着，但不限于，花费法术力或生命等资源。参见规则[118](/cr/1/#cr118)，“费用”。   
...
### <span id='指挥官'>指挥官</span> / <span id='Commander'>Commander</span>
...
### <span id='指挥官轮抽'>指挥官轮抽</span> / <span id='Commander Draft'>Commander Draft</span>
...
### <span id='致敬'>致敬</span> / <span id='Tribute'>Tribute</span>
一个关键字异能，允许对手选择让生物进战场时具有+1/+1指示物或一个额外异能。参见规则[702.104](/cr/7/#cr702-104)，“致敬”。   
...
### <span id='殖民'>殖民</span> / <span id='Populate'>Populate</span>
...
### <span id='致命伤害'>致命伤害</span> / <span id='Lethal Damage'>Lethal Damage</span>
伤害的数量大于或等于生物的防御力。参见规则[120.4a](/cr/1/#cr120-4a)、[120.6](/cr/1/#cr120-6)、[510.1](/cr/5/#cr510-1)以及[704.5g](/cr/7/#cr704-5g)。   
An amount of damage greater than or equal to a creature’s toughness. See rules 120.4a, 120.6, 510.1, and 704.5g.

### <span id='职业'>职业</span> / <span id='Class'>Class</span>
...
### <span id='职业选择'>职业选择</span> / <span id='Job Select'>Job Select</span>
...
### <span id='掷一颗d20'>掷一颗d20</span> / <span id='Roll a d20'>Roll a d20</span>
掷一颗二十面的骰子。类似地，d4是四面的骰子，d6是六面的骰子，依此类推。参见规则[706](/cr/7/#cr706)，“掷骰”。   
...
### <span id='掷硬币'>掷硬币</span> / <span id='Flipping a Coin'>Flipping a Coin</span>
...
### <span id='忠诚'>忠诚</span> / <span id='Loyalty'>Loyalty</span>
1. 只有鹏洛客牌具有的牌的一部分。鹏洛客牌的忠诚印在其右下角。参见规则[209](/cr/2/#cr209)，“忠诚”。   
...
2. 只有鹏洛客具有的特征。参见规则[306.5](/cr/3/#cr306-5)。   
2. A characteristic that only planeswalkers have. See rule 306.5.

### <span id='忠诚异能'>忠诚异能</span> / <span id='Loyalty Ability'>Loyalty Ability</span>
费用中具有忠诚符号的起动式异能。参见规则[606](/cr/6/#cr606)，“忠诚异能”。   
An activated ability with a loyalty symbol in its cost. See rule 606, “Loyalty Abilities.”

### <span id='中毒指示物'>中毒指示物</span> / <span id='Poison Counter'>Poison Counter</span>
可以给予牌手的一种指示物。参见规则[122](/cr/1/#cr122)，“指示物”，和规则[704.5c](/cr/7/#cr704-5c)。   
A counter that may be given to a player. See rule 122, “Counters,” and rule 704.5c.

### <span id='终结阶段'>终结阶段</span> / <span id='Ending Phase'>Ending Phase</span>
...
### <span id='终命指示物'>终命指示物</span> / <span id='Finality Counter'>Finality Counter</span>
...
### <span id='咒语'>咒语</span> / <span id='Spell'>Spell</span>
堆叠上的牌。以及堆叠上（无论是牌还是另一个咒语）的复制品。参见规则[112](/cr/1/#cr112)，“咒语”。   
A card on the stack. Also a copy (of either a card or another spell) on the stack. See rule 112, “Spells.”

### <span id='咒语类别'>咒语类别</span> / <span id='Spell Type'>Spell Type</span>
和瞬间牌张类别和法术牌张类别对应的副类别。参见规则[304](/cr/3/#cr304)，“瞬间”，以及规则[307](/cr/3/#cr307)，“法术”。参见规则[205.3k](/cr/2/#cr205-3k)的咒语类别列表。   
...
### <span id='咒语异能'>咒语异能</span> / <span id='Spell Ability'>Spell Ability</span>
异能的一种。咒语异能为在瞬间或法术咒语结算时其叙述所表达的异能。参见规则[113.3a](/cr/1/#cr113-3a)。   
...
### <span id='主动队伍'>主动队伍</span> / <span id='Active Team'>Active Team</span>
...
### <span id='主动牌手'>主动牌手</span> / <span id='Active Player'>Active Player</span>
主动牌手指轮到该回合的牌手。参见规则[102.1](/cr/1/#cr102-1)。   
The player whose turn it is. See rule 102.1.

### <span id='主动牌手先决定的顺序'>主动牌手先决定的顺序</span> / <span id='Active Player, Nonactive Player Order'>Active Player, Nonactive Player Order</span>
...
### <span id='助力'>助力</span> / <span id='Assist'>Assist</span>
...
### <span id='抓/平手（译者注：在英文中这两个词是相同的。）'>抓/平手（译者注：在英文中这两个词是相同的。）</span> / <span id='Draw'>Draw</span>
...
### <span id='抓牌步骤'>抓牌步骤</span> / <span id='Draw Step'>Draw Step</span>
...
### <span id='转化'>转化</span> / <span id='Transform'>Transform</span>
...
### <span id='转生'>转生</span> / <span id='Soulshift'>Soulshift</span>
一个关键字异能，让牌手将其坟墓场中的牌移回其手上。参见规则[702.46](/cr/7/#cr702-46)，“转生”。   
A keyword ability that lets a player return a card from their graveyard to their hand. See rule 702.46, “Soulshift.”

### <span id='转瞬'>转瞬</span> / <span id='Split Second'>Split Second</span>
一个关键字异能，让牌手几乎无法响应一个咒语。参见规则[702.61](/cr/7/#cr702-61)，“转瞬”。   
A keyword ability that makes it nearly impossible for a player to respond to a spell. See rule 702.61, “Split Second.”

### <span id='转移性效应'>转移性效应</span> / <span id='Redirection Effect'>Redirection Effect</span>
一种替代性效应，让对一个生物、鹏洛客、或牌手造成的伤害改为对另一个生物、鹏洛客、或牌手造成。参见规则[614.9](/cr/6/#cr614-9)。   
...
### <span id='转移（已废止）'>转移（已废止）</span> / <span id='Redirect (Obsolete)'>Redirect (Obsolete)</span>
一些老牌印有“转移”一词，表示一个转移性效应。这些牌在Oracle牌张参考文献中得到了勘误，从而它们明确的说明对一个物件或牌手将造成的伤害“改为”对另一个造成。参见转移性效应。   
...
### <span id='装配'>装配</span> / <span id='Fabricate'>Fabricate</span>
一个关键字异能，让你选择派出自动机衍生物或者在生物上放置+1/+1指示物。参见规则[702.123](/cr/7/#cr702-123)，“装配”。   
...
### <span id='状态'>状态</span> / <span id='Status'>Status</span>
一个永久物的物理状态。参见规则[110.5](/cr/1/#cr110-5)。   
The physical state of a permanent. See rule 110.5.

### <span id='状态触发'>状态触发</span> / <span id='State-Based Actions'>State-Based Actions</span>
...
### <span id='状态动作'>状态动作</span> / <span id='State Trigger'>State Trigger</span>
...
### <span id='追欢'>追欢</span> / <span id='Spree'>Spree</span>
一个见于某些具有模式之咒语上的关键字，允许你选择一个或数个模式，并需要为这些模式支付额外费用。参见规则[702.172](/cr/7/#cr702-172)，“追欢”。   
...
### <span id='追溯'>追溯</span> / <span id='Retrace'>Retrace</span>
一个关键字异能，让牌手从其坟墓场中施放牌。参见规则[702.81](/cr/7/#cr702-81)，“追溯”。   
A keyword ability that lets a player cast a card from their graveyard. See rule 702.81, “Retrace.”

### <span id='自身触发式异能'>自身触发式异能</span> / <span id='Reflexive Triggered Ability'>Reflexive Triggered Ability</span>
一种异能，根据先前咒语或异能结算过程中所作的动作而决定是否触发。参见规则[603.12](/cr/6/#cr603-12)。   
An ability that triggers based on actions taken earlier during a spell or ability’s resolution. See rule 603.12.

### <span id='自由奔跑'>自由奔跑</span> / <span id='Frenzy'>Frenzy</span>
...
### <span id='自由竞赛玩法'>自由竞赛玩法</span> / <span id='Freerunning'>Freerunning</span>
...
### <span id='子游戏'>子游戏</span> / <span id='Subgame'>Subgame</span>
由一个效应创造出的完全分开的万智牌游戏。参见规则[729](/cr/7/#cr729)，“子游戏”。   
A completely separate Magic game created by an effect. See rule 729, “Subgames.”

### <span id='总法术力费用（已废止）'>总法术力费用（已废止）</span> / <span id='Converted Mana Cost (Obsolete)'>Converted Mana Cost (Obsolete)</span>
...
### <span id='总费用'>总费用</span> / <span id='Total Cost'>Total Cost</span>
牌手实际需要为施放咒语或起动异能所支付的费用；法术力费用、起动费用、或替代性费用，加上所有增加的费用（包括额外费用）并减去所有减少的费用。参见规则[601.2f](/cr/6/#cr601-2f)。   
...
### <span id='总施放费用（已废止）'>总施放费用（已废止）</span> / <span id='Total Casting Cost (Obsolete)'>Total Casting Cost (Obsolete)</span>
法术力值的已废止用词。印有此叙述的牌已经在Oracle牌张参考文献中得到了勘误。   
An obsolete term for mana value. Cards printed with this term have received errata in the Oracle card reference.

### <span id='阻挡'>阻挡</span> / <span id='Block'>Block</span>
...
### <span id='组装'>组装</span> / <span id='Assemble'>Assemble</span>
...
### <span id='最后已知信息'>最后已知信息</span> / <span id='Last Known Information'>Last Known Information</span>
有关一个不再存在于它应在区域的物件，或有关一个不再在游戏中的牌手的信息。信息将抓住该物件在该区域中存在最后一刻的信息，或牌手在离开游戏前最后一刻的信息。参见规则[113.7a](/cr/1/#cr113-7a)、[608.2b](/cr/6/#cr608-2b)、[608.2g](/cr/6/#cr608-2g)以及[800.4h](/cr/8/#cr800-4h)。   
...
### <span id='罪行'>罪行</span> / <span id='Crime'>Crime</span>
...
### <span id='作出响应'>作出响应</span> / <span id='In Response To'>In Response To</span>
于另一个堆叠上的咒语或异能被施放或起动时，施放一个咒语或起动一个异能，指对前一个咒语或异能“作出响应”。参见规则[117.7](/cr/1/#cr117-7)。   
