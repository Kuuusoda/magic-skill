...
|-------|---------|---------|
| **Raw Data** (`raw/`) | Immutable source of truth | CR/MTR/IPG rule docs, historical card-data summaries, EDH data |
...
│   ├── data/                       # Build-time card-data summaries; runtime indices are generated by tools
...
### Data and Analysis
- The Wiki was built from a historical extract of 37,230 unique Oracle cards from 526,803 records; runtime local indices are optional generated artifacts
