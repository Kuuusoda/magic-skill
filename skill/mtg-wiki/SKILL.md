...
This skill release contains only core code. For the complete **187-page Wiki + 37,230-card database + bilingual CR/MTR/IPG rules** (~13MB total), clone the full repository:
...
- `wiki/` — 187-page local knowledge base (concepts, entities, sources, synthesis)
- `raw/cr/` — Complete Comprehensive Rules (bilingual)
...
After install, run `python3 raw/tools/mtg_wiki/build_indices.py` to build local indices.
